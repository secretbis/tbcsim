    ...
    val stackProc =
        fun(buff: Buff): Proc {
            return object : Proc() {
                ...
                // TODO: As far as I can tell from TBC footage, this won't refresh again from a proc
                // after
                // you get 5 stacks.
                //       Have to use Rampage again to maintain.  In pserver footage, this seems to
                // sometimes refresh at 5.
