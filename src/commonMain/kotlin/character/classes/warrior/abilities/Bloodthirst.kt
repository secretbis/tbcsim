...
class Bloodthirst : Ability() {
    ...
    override fun resourceCost(sp: SimParticipant): Double {
        ...
        val t5CostReduction =
            if (t5Bonus) {
                DestroyerBattlegear.fourSetBTMSCostReduction()
            } else 0.0
    ...
    override fun cast(sp: SimParticipant) {
        ...
        //       since that would allow things like Sword Spec to proc off of BT, which I presume it
        // can
        ...
        val t6Multiplier =
            if (t6Bonus) {
                OnslaughtBattlegear.fourSetMSBTDamageMultiplier()
            } else 1.0
