...
class ColdBlood() : Buff() {
    ...
    // this will also make it proc on Kick and Gouge which are not supposed to consume this buff.
    // Should not be relevant for dps sims though.
    override fun modifyStats(sp: SimParticipant): Stats {
        return Stats(yellowHitsAdditionalCritPct = 100.0)
    }
