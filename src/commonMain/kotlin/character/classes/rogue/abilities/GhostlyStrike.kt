...
class GhostlyStrike : Ability() {
    ...
    override fun available(sp: SimParticipant): Boolean {
        val gs =
            sp.character.klass.talents[character.classes.rogue.talents.GhostlyStrike.name]
                as character.classes.rogue.talents.GhostlyStrike?
        val available =
            if (gs != null) {
                gs.currentRank == gs.maxRank
            } else {
                false
            }
        if (!available) {
