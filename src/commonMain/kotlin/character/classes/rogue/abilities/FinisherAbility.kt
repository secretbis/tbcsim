...
abstract class FinisherAbility : Ability() {
    ...
    override open fun available(sp: SimParticipant): Boolean {
        // making sure at least 1 CP is available, but this should already be ensured in the
        // rotation
    ...
    protected fun fireProcAsFinisher(
        sp: SimParticipant,
        triggers: List<Proc.Trigger>?,
        items: List<Item>?,
        event: Event?,
    ) {
