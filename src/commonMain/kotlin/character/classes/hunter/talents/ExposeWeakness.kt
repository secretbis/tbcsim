            ...
            val apBuff =
                object : Buff() {
                    ...
                    override fun mutexPriority(sp: SimParticipant): Map<Mutex, Int> {
                        return mapOf(Mutex.BUFF_EXPOSE_WEAKNESS to sp.agility())
                    }

                    override fun modifyStats(sp: SimParticipant): Stats {
                        val totalAp = (0.25 * sp.agility()).toInt()
                        return Stats(attackPower = totalAp, rangedAttackPower = totalAp)
                    }
                }
            ...
            val proc =
                object : Proc() {
                    override val triggers: List<Trigger> =
                        listOf(Trigger.RANGED_AUTO_CRIT, Trigger.RANGED_WHITE_CRIT, Trigger.RANGED_YELLOW_CRIT)
