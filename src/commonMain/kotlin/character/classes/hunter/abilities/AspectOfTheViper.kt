    ...
    val buff =
        object : Buff() {
            ...
            override fun modifyStats(sp: SimParticipant): Stats {
                ...
                // Aspect of the Viper: This ability has received a slight redesign. The amount of
                // mana
                // regained will increase as the Hunter’s percentage of mana remaining decreases.
                // At about 60% mana, it is equivalent to the previous version of Aspect of the
                // Viper.
                // Below that margin, it is better (up to twice as much mana as the old version);
                // while
                // above that margin, it will be less effective.
                // The mana regained never drops below 10% of intellect every 5 sec. or goes above
                // 50% of
                // intellect every 5 sec.
                if (sp.resources[Resource.Type.MANA] == null) return Stats()

                val currentManaPct =
                    sp.resources[Resource.Type.MANA]!!.currentAmount / sp.resources[Resource.Type.MANA]!!.maxAmount
                val intMultiplier =
                    when {
