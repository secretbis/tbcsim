...
class AspectOfTheHawk : Ability() {
    ...
    val buff =
        object : Buff() {
            ...
            val proc =
                object : Proc() {
                    override val triggers: List<Trigger> = listOf(Trigger.RANGED_AUTO_HIT, Trigger.RANGED_AUTO_CRIT)
                    ...
                    override fun shouldProc(
                        ...
                        return sp.character.klass.hasTalentRanks(ImprovedAspectOfTheHawk.name) &&
