...
open class ChainLightning : Ability() {
    ...
    private fun actualCast(sp: SimParticipant, isLoProc: Boolean = false) {
        ...
        val damageRoll = Spell.baseDamageRoll(sp, baseDamage.first, baseDamage.second, school, spellPowerCoeff, totemSpellDmgBonus + totemAgSpellDmgBonus) * concussionMod * loMod
