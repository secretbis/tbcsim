...
class Orc : Race() {
    override var baseStats: Stats = Stats(strength = 3, agility = -3, stamina = 1, intellect = -3, spirit = 2)
    ...
    val axeSpec =
        object : Buff() {
            ...
            override fun modifyStats(sp: SimParticipant): Stats {
                ...
                return Stats(axeExpertiseRating = expertiseRating)
            }
        }
    ...
    val petDmg =
        object : Buff() {
            ...
            override fun modifyStats(sp: SimParticipant): Stats {
                return Stats(petDamageMultiplier = 1.05)
            }
        }
