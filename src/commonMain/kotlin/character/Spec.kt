...
abstract class Spec {
    companion object {
        ...
        val defaultMeleeDeltas: List<SpecEpDelta> =
            listOf(
                ...
                Triple(
                    "physicalHitRating",
                    Stats(physicalHitRating = -5.0 * Rating.physicalHitPerPct),
                    -5.0 * Rating.physicalHitPerPct,
                ),
                Triple(
                    "physicalHasteRating",
                    Stats(physicalHasteRating = 5.0 * Rating.hastePerPct),
                    5.0 * Rating.hastePerPct,
                ),
                Triple(
                    "expertiseRating",
                    Stats(expertiseRating = -2.0 * Rating.expertisePerPct),
        ...
        val defaultRangedDeltas: List<SpecEpDelta> =
            listOf(
                Triple("agility", Stats(agility = 50), 50.0),
                Triple("rangedCritRating", Stats(rangedCritRating = 5.0 * Rating.critPerPct), 5.0 * Rating.critPerPct),
                Triple(
                    "physicalHitRating",
                    Stats(physicalHitRating = -2.0 * Rating.physicalHitPerPct),
                    -2.0 * Rating.physicalHitPerPct,
                ),
                Triple(
                    "physicalHasteRating",
                    Stats(physicalHasteRating = 5.0 * Rating.hastePerPct),
        ...
        val casterHybridDeltas =
            listOf(
                Triple("spellCritRating", Stats(spellCritRating = 5.0 * Rating.critPerPct), 5.0 * Rating.critPerPct),
                Triple(
                    "spellHitRating",
                    Stats(spellHitRating = -5.0 * Rating.spellHitPerPct),
                    -5.0 * Rating.spellHitPerPct,
                ),
            )
        val defaultCasterDeltas: List<SpecEpDelta> =
            listOf(
