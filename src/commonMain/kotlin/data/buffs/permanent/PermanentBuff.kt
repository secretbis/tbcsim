...
abstract class PermanentBuff : Buff() {
    ...
    // Gear stats implemented as buffs like "Attack Power 12" and stat enchants fit this category
    // well
    // This field is currently only read by Gear, since abilities almost always have talents or
    // procs
    // that need
