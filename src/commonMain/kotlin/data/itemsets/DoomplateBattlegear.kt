...
class DoomplateBattlegear : ItemSet() {
    companion object {
        const val TWO_SET_BUFF_NAME = "Doomplate Battlegear (2 set)"
        const val FOUR_SET_BUFF_NAME = "Doomplate Battlegear (4 set)"
    }
    override val id: Int = 661

    val twoBuff = object : Buff() {
        override val name: String = TWO_SET_BUFF_NAME
        override val icon: String = "inv_gauntlets_29.jpg"
