...
class WastewalkerArmor : ItemSet() {
    companion object {
        const val TWO_SET_BUFF_NAME = "Wastewalker Armor (2 set)"
        const val FOUR_SET_BUFF_NAME = "Wastewalker Armor (4 set)"
    }

    override val id: Int = 659

    val twoBuff =
        object : Buff() {
            override val name: String = TWO_SET_BUFF_NAME
            override val icon: String = "inv_chest_chain_17.jpg"
        ...
        object : Buff() {
            ...
            val apBuff =
                object : Buff() {
                    ...
                    override fun modifyStats(sp: SimParticipant): Stats {
                        return Stats(attackPower = 160, rangedAttackPower = 160)
                    }
                }
