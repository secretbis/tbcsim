...
@JsExport
class AmethystBeholderEyeOfShadowWrath : Item() {
    override var isAutoGenerated: Boolean = false
    override var id: Int = 31220
    override var name: String = "Amethyst Beholder Eye of Shadow Wrath"
    override var itemLevel: Int = 109
    override var quality: Int = 3
    override var icon: String = "inv_misc_eye_01.jpg"
    override var inventorySlot: Int = 1
    ...
    override var stats: Stats = Stats(shadowDamage = 85)
