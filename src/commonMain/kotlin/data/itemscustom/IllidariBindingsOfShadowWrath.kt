...
@JsExport
class IllidariBindingsOfShadowWrath : Item() {
    override var isAutoGenerated: Boolean = false
    override var id: Int = 31225
    override var name: String = "Illidari Bindings of Shadow Wrath"
    ...
    override var stats: Stats = Stats(shadowDamage = 47)
