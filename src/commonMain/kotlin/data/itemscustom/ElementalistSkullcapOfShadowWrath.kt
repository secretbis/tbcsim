...
@JsExport
class ElementalistSkullcapOfShadowWrath : Item() {
    override var isAutoGenerated: Boolean = false
    override var id: Int = 24689
    override var name: String = "Elementalist Skullcap of Shadow Wrath"
    override var itemLevel: Int = 120
    override var quality: Int = 2
    override var icon: String = "inv_helmet_59.jpg"
    ...
    override var stats: Stats = Stats(shadowDamage = 80)
