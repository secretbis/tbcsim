...
enum class Prefix(val stat: List<GemStat>) {
    ...
    TEARDROP(
        listOf(GemStat(Constants.StatType.SPELL_HEALING, 13, 18, 22), GemStat(Constants.StatType.SPELL_DAMAGE, 5, 6, 8))
    ),
    ...
    // Orange
    INSCRIBED(listOf(GemStat(Constants.StatType.STRENGTH, 3, 4, 5), GemStat(Constants.StatType.CRIT_RATING, 3, 4, 5))),
    GLINTING(listOf(GemStat(Constants.StatType.AGILITY, 3, 4, 5), GemStat(Constants.StatType.HIT_RATING, 3, 4, 5))),
    POTENT(
        listOf(
    ...
    WICKED(
        listOf(GemStat(Constants.StatType.ATTACK_POWER, 6, 8, 10), GemStat(Constants.StatType.CRIT_RATING, 3, 4, 5))
    ),
    VEILED(
        listOf(GemStat(Constants.StatType.SPELL_DAMAGE, 4, 5, 6), GemStat(Constants.StatType.HIT_SPELL_RATING, 3, 4, 5))
    ),
    LUMINOUS(
        listOf(
    ...
    // Green
    JAGGED(listOf(GemStat(Constants.StatType.CRIT_RATING, 3, 4, 5), GemStat(Constants.StatType.STAMINA, 4, 6, 7))),
    ENDURING(
        listOf(GemStat(Constants.StatType.DEFENSE_SKILL_RATING, 3, 4, 5), GemStat(Constants.StatType.STAMINA, 4, 6, 7))
    ),
    DAZZLING(
        listOf(GemStat(Constants.StatType.INTELLECT, 3, 4, 5), GemStat(Constants.StatType.MANA_PER_5_SECONDS, 1, 2, 3))
    ),
    RADIANT(
        listOf(GemStat(Constants.StatType.CRIT_SPELL_RATING, 3, 4, 5), GemStat(Constants.StatType.SPELL_PEN, 4, 5, 6))
    ),
    STEADY(
        listOf(GemStat(Constants.StatType.RESILIENCE_RATING, 4, 5, 6), GemStat(Constants.StatType.STAMINA, 4, 6, 7))
    ),

    // Purple
    SOVEREIGN(listOf(GemStat(Constants.StatType.STRENGTH, 3, 4, 5), GemStat(Constants.StatType.STAMINA, 4, 6, 7))),
    SHIFTING(listOf(GemStat(Constants.StatType.AGILITY, 3, 4, 5), GemStat(Constants.StatType.STAMINA, 4, 6, 7))),
    GLOWING(listOf(GemStat(Constants.StatType.SPELL_DAMAGE, 4, 5, 6), GemStat(Constants.StatType.STAMINA, 4, 6, 7))),
    BALANCED(listOf(GemStat(Constants.StatType.ATTACK_POWER, 6, 8, 10), GemStat(Constants.StatType.STAMINA, 4, 6, 7))),
    ROYAL(
        listOf(
            GemStat(Constants.StatType.SPELL_HEALING, 7, 9, 11),
            GemStat(Constants.StatType.SPELL_DAMAGE, 3, 3, 4),
    ...
    REGAL(listOf(GemStat(Constants.StatType.DODGE_RATING, 0, 4, 5), GemStat(Constants.StatType.STAMINA, 0, 6, 6))),
}
