...
object Enchants {
    val enchants = arrayOf(
        ...
        { item: Item -> BracerFortitude(item) },
        ...
        { item: Item -> GreaterInscriptionOfTheKnight(item) },
        ...
        { item: Item -> NethercleftLegArmor(item) },
        { item: Item -> PresenceOfMight(item) },
