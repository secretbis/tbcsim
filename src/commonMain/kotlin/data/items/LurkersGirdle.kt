...
@JsExport
public class LurkersGirdle : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30678

    public override var name: String = "Lurker's Girdle"
    ...
    public override var stats: Stats = Stats(armor = 816)
