...
@JsExport
public class IdolOfTheWhiteStag : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32257

    public override var name: String = "Idol of the White Stag"

    public override var itemLevel: Int = 141

    public override var quality: Int = 4

    public override var icon: String = "inv_qirajidol_alabaster.jpg"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(41037, "Mangle AP Buff", this)) }
}
