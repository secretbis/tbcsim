...
@JsExport
@Serializable
public class BrutalGladiatorsSlicer : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35101

  public override var name: String = "Brutal Gladiator's Slicer"
  ...
  public override var minDmg: Double = 224.0
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BrutalGladiatorsSlicer::class, serializer()) }
}
