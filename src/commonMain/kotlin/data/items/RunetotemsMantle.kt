...
@JsExport
public class RunetotemsMantle : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30111

    public override var name: String = "Runetotem's Mantle"
    ...
    public override var stats: Stats = Stats(stamina = 31, intellect = 22, spirit = 32, armor = 326)
