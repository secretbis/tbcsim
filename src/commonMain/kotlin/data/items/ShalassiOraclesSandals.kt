...
@JsExport
@Serializable
public class ShalassiOraclesSandals : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 25970

  public override var name: String = "Shalassi Oracle's Sandals"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      ShalassiOraclesSandals::class, serializer()) }
}
