...
@JsExport
public class BandsOfNefariousDeeds : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28515

    public override var name: String = "Bands of Nefarious Deeds"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 22, armor = 85)
