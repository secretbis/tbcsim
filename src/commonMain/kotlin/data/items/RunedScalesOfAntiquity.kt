...
@JsExport
public class RunedScalesOfAntiquity : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34931

    public override var name: String = "Runed Scales of Antiquity"
    ...
    public override var stats: Stats = Stats(stamina = 45, intellect = 38, armor = 864)
