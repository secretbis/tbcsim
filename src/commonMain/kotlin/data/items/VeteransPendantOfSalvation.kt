...
@JsExport
public class VeteransPendantOfSalvation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33068

    public override var name: String = "Veteran's Pendant of Salvation"
    ...
    public override var stats: Stats = Stats(stamina = 30, intellect = 13, resilienceRating = 18.0)
