...
@JsExport
public class MindstormWristbands : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29918

    public override var name: String = "Mindstorm Wristbands"
    ...
    public override var stats: Stats = Stats(stamina = 13, intellect = 13, armor = 94, spellCritRating = 23.0)
