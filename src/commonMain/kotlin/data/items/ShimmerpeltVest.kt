...
@JsExport
public class ShimmerpeltVest : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33322

    public override var name: String = "Shimmer-pelt Vest"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 35, spirit = 30, armor = 404)
