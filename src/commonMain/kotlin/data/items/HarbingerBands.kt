...
@JsExport
public class HarbingerBands : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28477

    public override var name: String = "Harbinger Bands"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 21, spirit = 14, armor = 85)
