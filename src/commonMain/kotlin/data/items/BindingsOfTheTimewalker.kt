...
@JsExport
public class BindingsOfTheTimewalker : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29183

    public override var name: String = "Bindings of the Timewalker"
    ...
    public override var stats: Stats = Stats(stamina = 24, intellect = 12, armor = 78)
