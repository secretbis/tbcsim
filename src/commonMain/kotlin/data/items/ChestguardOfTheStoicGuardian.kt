...
@JsExport
public class ChestguardOfTheStoicGuardian : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33522

    public override var name: String = "Chestguard of the Stoic Guardian"
    ...
    public override var stats: Stats = Stats(stamina = 60, armor = 1607, defenseRating = 22.0, dodgeRating = 38.0)
