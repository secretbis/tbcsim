...
@JsExport
public class LibramOfZeal : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27983

    public override var name: String = "Libram of Zeal"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(33557, "Improved Seal of the Crusader", this))
    }
}
