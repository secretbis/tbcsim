...
@JsExport
public class LivingReplicatorSpecs : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32475

    public override var name: String = "Living Replicator Specs"
    ...
    public override var stats: Stats = Stats(stamina = 14, intellect = 38, armor = 726)
