...
@JsExport
public class KrakkenHeartBreastplate : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30102

    public override var name: String = "Krakken-Heart Breastplate"
    ...
    public override var stats: Stats =
        Stats(strength = 61, agility = 43, stamina = 42, armor = 1728, physicalHitRating = 30.0)
