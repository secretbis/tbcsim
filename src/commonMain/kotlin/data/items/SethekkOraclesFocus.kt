...
@JsExport
public class SethekkOraclesFocus : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29334

    public override var name: String = "Sethekk Oracle's Focus"
    ...
    public override var stats: Stats = Stats(intellect = 19)
