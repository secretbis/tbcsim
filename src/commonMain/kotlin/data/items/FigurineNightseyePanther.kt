...
@JsExport
@Serializable
public class FigurineNightseyePanther : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 24128

  public override var name: String = "Figurine - Nightseye Panther"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      FigurineNightseyePanther::class, serializer()) }
}
