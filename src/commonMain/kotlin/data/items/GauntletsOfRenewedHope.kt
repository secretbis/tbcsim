...
@JsExport
public class GauntletsOfRenewedHope : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28505

    public override var name: String = "Gauntlets of Renewed Hope"
    ...
    public override var stats: Stats = Stats(stamina = 19, intellect = 29, armor = 906)
