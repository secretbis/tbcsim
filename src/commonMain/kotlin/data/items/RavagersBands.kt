...
@JsExport
public class RavagersBands : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30686

    public override var name: String = "Ravager's Bands"
    ...
    public override var stats: Stats = Stats(armor = 355)
