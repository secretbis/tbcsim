...
@JsExport
public class SindoreiPendantOfSalvation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 35291

    public override var name: String = "Sin'dorei Pendant of Salvation"
    ...
    public override var stats: Stats = Stats(stamina = 16, intellect = 19, resilienceRating = 18.0)
