...
@JsExport
@Serializable
public class VengefulGladiatorsMutilator : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 33801

  public override var name: String = "Vengeful Gladiator's Mutilator"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      VengefulGladiatorsMutilator::class, serializer()) }
}
