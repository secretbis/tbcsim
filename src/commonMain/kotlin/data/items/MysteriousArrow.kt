...
@JsExport
public class MysteriousArrow : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34581

    public override var name: String = "Mysterious Arrow"

    public override var itemLevel: Int = 120

    public override var quality: Int = 4

    public override var icon: String = "inv_misc_ammo_arrow_02.jpg"
