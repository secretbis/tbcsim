...
@JsExport
public class TankatronicGoggles : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32473

    public override var name: String = "Tankatronic Goggles"
    ...
    public override var stats: Stats =
        Stats(stamina = 67, armor = 1296, physicalHitRating = 13.0, defenseRating = 38.0, dodgeRating = 22.0)
