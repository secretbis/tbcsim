...
@JsExport
@Serializable
public class AssassinsAlchemistStone : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35751

  public override var name: String = "Assassin's Alchemist Stone"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      AssassinsAlchemistStone::class, serializer()) }
}
