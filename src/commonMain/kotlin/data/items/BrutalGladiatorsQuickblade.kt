...
@JsExport
@Serializable
public class BrutalGladiatorsQuickblade : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35072

  public override var name: String = "Brutal Gladiator's Quickblade"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BrutalGladiatorsQuickblade::class, serializer()) }
}
