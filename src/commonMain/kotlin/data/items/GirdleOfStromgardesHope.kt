...
@JsExport
public class GirdleOfStromgardesHope : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33446

    public override var name: String = "Girdle of Stromgarde's Hope"
    ...
    public override var stats: Stats = Stats(stamina = 23, intellect = 26, armor = 904, spellCritRating = 16.0)
