...
@JsExport
public class UthersCeremonialWarboots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27420

    public override var name: String = "Uther's Ceremonial Warboots"
    ...
    public override var stats: Stats = Stats(strength = 25, stamina = 21, intellect = 20, armor = 720)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(21629, "Increased Mana Regen", this))
    }
}
