...
@JsExport
public class ShaardeTheLesser : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 25964

    public override var name: String = "Shaarde the Lesser"
    ...
    public override var stats: Stats = Stats(stamina = 25, expertiseRating = 14.0)
