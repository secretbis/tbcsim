...
@JsExport
public class ShieldOfCondemnation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 22819

    public override var name: String = "Shield of Condemnation"

    public override var itemLevel: Int = 92

    public override var quality: Int = 4

    public override var icon: String = "inv_shield_28.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 10, intellect = 10, armor = 3936)
