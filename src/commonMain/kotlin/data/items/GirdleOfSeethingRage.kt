...
@JsExport
public class GirdleOfSeethingRage : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34944

    public override var name: String = "Girdle of Seething Rage"
    ...
    public override var stats: Stats = Stats(strength = 40, stamina = 55, armor = 993, physicalHasteRating = 30.0)
