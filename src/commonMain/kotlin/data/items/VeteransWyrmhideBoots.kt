...
@JsExport
public class VeteransWyrmhideBoots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32796

    public override var name: String = "Veteran's Wyrmhide Boots"
    ...
    public override var stats: Stats = Stats(stamina = 39, intellect = 27, armor = 336, resilienceRating = 26.0)
