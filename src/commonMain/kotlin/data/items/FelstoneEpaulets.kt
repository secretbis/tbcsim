...
@JsExport
public class FelstoneEpaulets : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31160

    public override var name: String = "Felstone Epaulets"
    ...
    public override var stats: Stats = Stats(armor = 464)
