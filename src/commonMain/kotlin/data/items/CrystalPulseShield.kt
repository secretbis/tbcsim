...
@JsExport
public class CrystalPulseShield : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31292

    public override var name: String = "Crystal Pulse Shield"
    ...
    public override var stats: Stats = Stats(intellect = 24, armor = 3711)
