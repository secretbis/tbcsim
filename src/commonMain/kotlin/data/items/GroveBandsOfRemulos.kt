...
@JsExport
public class GroveBandsOfRemulos : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30062

    public override var name: String = "Grove-Bands of Remulos"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 14, spirit = 21, armor = 177)
