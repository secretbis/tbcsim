...
public class TwinbladeOfThePhoenix : Item() {
    ...
    public override var stats: Stats = Stats(stamina = 53, meleeCritRating = 37.0, rangedCritRating = 37.0)

    public override var sockets: Array<Socket> = arrayOf(Socket(Color.RED), Socket(Color.YELLOW), Socket(Color.BLUE))

    public override var socketBonus: SocketBonus? = SocketBonuses.byId(2936)

    public override var phase: Int = 2

    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(34751, "Attack Power 110", this)) }
}
