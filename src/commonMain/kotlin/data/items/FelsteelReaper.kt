...
public class FelsteelReaper : Item() {
    ...
    public override var id: Int = 23543
    ...
    public override var stats: Stats = Stats(meleeCritRating = 30.0, rangedCritRating = 30.0)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(36069, "Attack Power 112", this)) }
}
