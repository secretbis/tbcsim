...
@JsExport
public class TidefuryHelm : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28349

    public override var name: String = "Tidefury Helm"
    ...
    public override var stats: Stats = Stats(stamina = 31, intellect = 26, armor = 530)
