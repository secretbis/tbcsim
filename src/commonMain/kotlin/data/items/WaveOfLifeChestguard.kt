...
@JsExport
public class WaveOfLifeChestguard : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34930

    public override var name: String = "Wave of Life Chestguard"
    ...
    public override var stats: Stats = Stats(stamina = 39, intellect = 51, armor = 988)
