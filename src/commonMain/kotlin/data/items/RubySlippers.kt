...
@JsExport
public class RubySlippers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28585

    public override var name: String = "Ruby Slippers"
    ...
    public override var stats: Stats = Stats(stamina = 33, intellect = 29, armor = 134, spellHitRating = 16.0)
