...
@JsExport
public class SlippersOfDutifulMending : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34926

    public override var name: String = "Slippers of Dutiful Mending"
    ...
    public override var stats: Stats = Stats(stamina = 28, intellect = 25, spirit = 34, armor = 162)
