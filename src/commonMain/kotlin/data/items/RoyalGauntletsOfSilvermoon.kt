...
@JsExport
public class RoyalGauntletsOfSilvermoon : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29998

    public override var name: String = "Royal Gauntlets of Silvermoon"
    ...
    public override var stats: Stats = Stats(stamina = 57, armor = 1080, defenseRating = 24.0, dodgeRating = 32.0)
