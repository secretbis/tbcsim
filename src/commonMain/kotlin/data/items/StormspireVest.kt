...
@JsExport
public class StormspireVest : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29117

    public override var name: String = "Stormspire Vest"
    ...
    public override var stats: Stats = Stats(stamina = 49, armor = 156)
