...
@JsExport
@Serializable
public class DarkIronSmokingPipe : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 38290

  public override var name: String = "Dark Iron Smoking Pipe"

  public override var itemLevel: Int = 110

  public override var quality: Int = 4

  public override var icon: String = "inv_misc_pipe_01.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      DarkIronSmokingPipe::class, serializer()) }
}
