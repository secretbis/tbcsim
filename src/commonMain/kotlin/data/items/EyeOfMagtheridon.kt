...
@JsExport
@Serializable
public class EyeOfMagtheridon : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 28789

  public override var name: String = "Eye of Magtheridon"

  public override var itemLevel: Int = 125

  public override var quality: Int = 4

  public override var icon: String = "inv_elemental_mote_life01.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      EyeOfMagtheridon::class, serializer()) }
}
