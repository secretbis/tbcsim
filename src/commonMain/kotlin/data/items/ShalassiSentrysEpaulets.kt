...
@JsExport
@Serializable
public class ShalassiSentrysEpaulets : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 25968

  public override var name: String = "Shalassi Sentry's Epaulets"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      ShalassiSentrysEpaulets::class, serializer()) }
}
