...
@JsExport
public class ShatteredSunPendantOfAcumen : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34678

    public override var name: String = "Shattered Sun Pendant of Acumen"
    ...
    public override var stats: Stats = Stats(stamina = 19, intellect = 18)
