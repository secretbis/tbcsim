...
@JsExport
@Serializable
public class TheEssenceFocuser : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 31304

  public override var name: String = "The Essence Focuser"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      TheEssenceFocuser::class, serializer()) }
}
