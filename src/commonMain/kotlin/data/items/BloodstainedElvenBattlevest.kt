...
@JsExport
public class BloodstainedElvenBattlevest : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33215

    public override var name: String = "Bloodstained Elven Battlevest"
    ...
    public override var stats: Stats =
        Stats(strength = 46, stamina = 69, armor = 1607, meleeCritRating = 35.0, rangedCritRating = 35.0)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(40679, "Armor Penetration 161", this))
    }
}
