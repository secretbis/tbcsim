...
@JsExport
public class IdolOfTheAvenger : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31025

    public override var name: String = "Idol of the Avenger"

    public override var itemLevel: Int = 106

    public override var quality: Int = 3

    public override var icon: String = "inv_misc_rune_10.jpg"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(37760, "Increased Wrath Damage", this))
    }
}
