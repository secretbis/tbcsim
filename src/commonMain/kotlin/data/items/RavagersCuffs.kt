...
@JsExport
public class RavagersCuffs : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30684

    public override var name: String = "Ravager's Cuffs"
    ...
    public override var stats: Stats = Stats(armor = 85)
