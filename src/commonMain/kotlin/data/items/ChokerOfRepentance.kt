...
@JsExport
public class ChokerOfRepentance : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31321

    public override var name: String = "Choker of Repentance"
    ...
    public override var stats: Stats = Stats(strength = 23, intellect = 15)
