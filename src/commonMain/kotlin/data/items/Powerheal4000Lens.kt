...
@JsExport
public class Powerheal4000Lens : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32495

    public override var name: String = "Powerheal 4000 Lens"
    ...
    public override var stats: Stats = Stats(stamina = 14, intellect = 38, spirit = 28, armor = 174)
