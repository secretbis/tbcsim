...
public class LionheartBlade : Item() {
    ...
    public override var icon: String = "inv_sword_2h_blacksmithing_01.jpg"
    ...
    public override var stats: Stats = Stats(strength = 47, agility = 42)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(34514, "Fear Resistance 5", this)) }
}
