...
@JsExport
public class JaggedBarkPendant : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28343

    public override var name: String = "Jagged Bark Pendant"
    ...
    public override var stats: Stats = Stats(agility = 26, stamina = 15)
