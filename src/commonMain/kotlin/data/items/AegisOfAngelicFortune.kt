...
@JsExport
public class AegisOfAngelicFortune : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34231

    public override var name: String = "Aegis of Angelic Fortune"
    ...
    public override var stats: Stats = Stats(stamina = 33, intellect = 21, armor = 6459)
