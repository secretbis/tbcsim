...
@JsExport
public class LifestepBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33483

    public override var name: String = "Life-step Belt"
    ...
    public override var stats: Stats = Stats(stamina = 20, intellect = 23, spirit = 22, armor = 227)
