...
@JsExport
public class IdolOfBuddingLife : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33508

    public override var name: String = "Idol of Budding Life"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(43736, "Reduced Rejuvenation Cost", this))
    }
}
