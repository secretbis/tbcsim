...
@JsExport
public class PrimalAttunedGoggles : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 35184

    public override var name: String = "Primal-Attuned Goggles"
    ...
    public override var stats: Stats = Stats(stamina = 32, intellect = 51, armor = 902)
