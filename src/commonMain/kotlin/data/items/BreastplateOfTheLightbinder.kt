...
@JsExport
public class BreastplateOfTheLightbinder : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28662

    public override var name: String = "Breastplate of the Lightbinder"
    ...
    public override var stats: Stats = Stats(stamina = 28, intellect = 40, armor = 1450)
