...
@JsExport
public class BrighthelmOfJustice : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30048

    public override var name: String = "Brighthelm of Justice"
    ...
    public override var stats: Stats = Stats(stamina = 36, intellect = 44, armor = 1306)
