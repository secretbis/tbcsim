...
@JsExport
@Serializable
public class FigurineShadowsongPanther : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35702

  public override var name: String = "Figurine - Shadowsong Panther"

  public override var itemLevel: Int = 125

  public override var quality: Int = 4

  public override var icon: String = "inv_jewelcrafting_blackpearlpanther.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      FigurineShadowsongPanther::class, serializer()) }
}
