...
@JsExport
public class MonsoonBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30044

    public override var name: String = "Monsoon Belt"
    ...
    public override var stats: Stats = Stats(stamina = 23, intellect = 24, armor = 506, spellHitRating = 21.0)
