...
@JsExport
public class InfernoHardenedBoots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30779

    public override var name: String = "Inferno Hardened Boots"
    ...
    public override var stats: Stats = Stats(stamina = 36, armor = 250)
