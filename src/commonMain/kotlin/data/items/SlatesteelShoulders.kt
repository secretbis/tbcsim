...
@JsExport
public class SlatesteelShoulders : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31577

    public override var name: String = "Slatesteel Shoulders"
    ...
    public override var stats: Stats = Stats(armor = 873)
