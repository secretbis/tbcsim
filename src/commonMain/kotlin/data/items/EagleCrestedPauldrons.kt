...
@JsExport
@Serializable
public class EagleCrestedPauldrons : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 25967

  public override var name: String = "Eagle Crested Pauldrons"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      EagleCrestedPauldrons::class, serializer()) }
}
