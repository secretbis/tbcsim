...
@JsExport
public class TheDarkenersGrasp : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30007

    public override var name: String = "The Darkener's Grasp"
    ...
    public override var stats: Stats = Stats(stamina = 40, defenseRating = 27.0, blockRating = 14.0, dodgeRating = 23.0)
