...
@JsExport
public class SpellslingersProtector : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28030

    public override var name: String = "Spell-slinger's Protector"
    ...
    public override var stats: Stats =
        Stats(stamina = 15, intellect = 14, spirit = 9, armor = 66, spellCritRating = 13.0)
