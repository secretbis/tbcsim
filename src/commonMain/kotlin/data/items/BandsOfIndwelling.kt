...
@JsExport
public class BandsOfIndwelling : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28511

    public override var name: String = "Bands of Indwelling"
    ...
    public override var stats: Stats = Stats(stamina = 22, intellect = 18, spirit = 20, armor = 85)
