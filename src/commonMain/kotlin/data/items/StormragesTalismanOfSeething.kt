...
@JsExport
public class StormragesTalismanOfSeething : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 23053

    public override var name: String = "Stormrage's Talisman of Seething"

    public override var itemLevel: Int = 92

    public override var quality: Int = 4

    public override var icon: String = "inv_jewelry_necklace_28naxxramas.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 12)
