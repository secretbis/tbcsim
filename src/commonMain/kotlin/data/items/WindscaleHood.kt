...
@JsExport
public class WindscaleHood : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29504

    public override var name: String = "Windscale Hood"
    ...
    public override var stats: Stats = Stats(stamina = 16, intellect = 18, armor = 271, spellCritRating = 37.0)
