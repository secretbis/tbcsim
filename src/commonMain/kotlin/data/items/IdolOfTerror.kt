...
@JsExport
public class IdolOfTerror : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33509

    public override var name: String = "Idol of Terror"

    public override var itemLevel: Int = 128

    public override var quality: Int = 4

    public override var icon: String = "ability_druid_demoralizingroar.jpg"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(43737, "Primal Instinct", this)) }
}
