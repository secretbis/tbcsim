...
@JsExport
public class BootsOfTheEndlessHunt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29262

    public override var name: String = "Boots of the Endless Hunt"
    ...
    public override var stats: Stats = Stats(agility = 26, stamina = 19, intellect = 23, armor = 535)
