...
@JsExport
public class LolasEve : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31339

    public override var name: String = "Lola's Eve"
    ...
    public override var stats: Stats = Stats(stamina = 15, intellect = 14, spirit = 13)
