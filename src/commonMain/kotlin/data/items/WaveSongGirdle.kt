...
@JsExport
public class WaveSongGirdle : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29244

    public override var name: String = "Wave-Song Girdle"
    ...
    public override var stats: Stats = Stats(stamina = 25, intellect = 25, armor = 438, spellCritRating = 23.0)
