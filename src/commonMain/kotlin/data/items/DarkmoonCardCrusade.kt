...
@JsExport
@Serializable
public class DarkmoonCardCrusade : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 31856

  public override var name: String = "Darkmoon Card: Crusade"

  public override var itemLevel: Int = 100

  public override var quality: Int = 4

  public override var icon: String = "inv_misc_ticket_tarot_crusade.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      DarkmoonCardCrusade::class, serializer()) }
}
