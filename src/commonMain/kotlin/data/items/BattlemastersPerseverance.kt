...
@JsExport
@Serializable
public class BattlemastersPerseverance : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 34580

  public override var name: String = "Battlemaster's Perseverance"

  public override var itemLevel: Int = 133

  public override var quality: Int = 4

  public override var icon: String = "spell_holy_heroism.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BattlemastersPerseverance::class, serializer()) }
}
