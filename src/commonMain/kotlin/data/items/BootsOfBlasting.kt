...
@JsExport
public class BootsOfBlasting : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30037

    public override var name: String = "Boots of Blasting"
    ...
    public override var stats: Stats =
        Stats(stamina = 25, intellect = 25, armor = 148, spellCritRating = 25.0, spellHitRating = 18.0)
