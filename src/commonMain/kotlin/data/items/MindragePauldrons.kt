...
@JsExport
public class MindragePauldrons : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27816

    public override var name: String = "Mindrage Pauldrons"
    ...
    public override var stats: Stats = Stats(stamina = 22, intellect = 15, armor = 117)
