...
@JsExport
public class MarshalsKodohideBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31596

    public override var name: String = "Marshal's Kodohide Belt"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 23, armor = 259, resilienceRating = 24.0)
