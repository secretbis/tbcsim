...
@JsExport
public class LivingRubyPendant : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 24110

    public override var name: String = "Living Ruby Pendant"

    public override var itemLevel: Int = 113

    public override var quality: Int = 3

    public override var icon: String = "inv_jewelry_necklace_15.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 24, intellect = 15)
