...
@JsExport
public class TalismanOfTheSunKing : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29923

    public override var name: String = "Talisman of the Sun King"

    public override var itemLevel: Int = 128

    public override var quality: Int = 4

    public override var icon: String = "inv_offhand_blood_02.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 24)
