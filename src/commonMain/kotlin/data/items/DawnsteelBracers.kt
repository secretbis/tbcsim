...
@JsExport
public class DawnsteelBracers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32571

    public override var name: String = "Dawnsteel Bracers"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 23, armor = 772, spellHasteRating = 28.0)
