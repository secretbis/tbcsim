...
@JsExport
public class MantleOfAbrahmis : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28743

    public override var name: String = "Mantle of Abrahmis"
    ...
    public override var stats: Stats = Stats(strength = 21, stamina = 43, armor = 1087, defenseRating = 23.0)
