...
@JsExport
public class BootsOfEffortlessStriking : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30060

    public override var name: String = "Boots of Effortless Striking"
    ...
    public override var stats: Stats = Stats(agility = 42, stamina = 41, armor = 278)
