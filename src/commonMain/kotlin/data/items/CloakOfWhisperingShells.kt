...
@JsExport
public class CloakOfWhisperingShells : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27789

    public override var name: String = "Cloak of Whispering Shells"
    ...
    public override var stats: Stats = Stats(stamina = 15, intellect = 16, armor = 76)
