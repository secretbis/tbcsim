...
@JsExport
public class JeweledBootsOfSanctification : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27525

    public override var name: String = "Jeweled Boots of Sanctification"
    ...
    public override var stats: Stats = Stats(stamina = 22, intellect = 25, armor = 105)
