...
@JsExport
public class GirdleOfTheProtector : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33524

    public override var name: String = "Girdle of the Protector"
    ...
    public override var stats: Stats =
        Stats(stamina = 40, armor = 904, spellHitRating = 18.0, defenseRating = 11.0, dodgeRating = 27.0)
