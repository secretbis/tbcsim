...
@JsExport
public class SteelspineFaceguard : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28671

    public override var name: String = "Steelspine Faceguard"

    public override var itemLevel: Int = 115

    public override var quality: Int = 4

    public override var icon: String = "inv_helmet_05.jpg"
    ...
    public override var stats: Stats = Stats(agility = 36, stamina = 34, intellect = 34, armor = 659)
