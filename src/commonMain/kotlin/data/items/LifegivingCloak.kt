...
@JsExport
public class LifegivingCloak : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31329

    public override var name: String = "Lifegiving Cloak"
    ...
    public override var stats: Stats = Stats(intellect = 13, armor = 85)
