...
@JsExport
public class GladiatorsGavel : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32450

    public override var name: String = "Gladiator's Gavel"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(41973, "Increase Spell Dam 199", this))
    }
}
