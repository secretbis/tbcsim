...
@JsExport
public class TelescopicSharprifle : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28286

    public override var name: String = "Telescopic Sharprifle"
    ...
    public override var stats: Stats = Stats(agility = 13)
