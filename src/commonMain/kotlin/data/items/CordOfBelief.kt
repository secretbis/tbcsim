...
@JsExport
public class CordOfBelief : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27542

    public override var name: String = "Cord of Belief"
    ...
    public override var stats: Stats = Stats(intellect = 23, spirit = 20, armor = 88)
