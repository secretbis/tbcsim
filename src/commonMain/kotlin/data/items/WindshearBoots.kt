...
@JsExport
public class WindshearBoots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28810

    public override var name: String = "Windshear Boots"
    ...
    public override var stats: Stats = Stats(stamina = 37, intellect = 32, armor = 605, spellHitRating = 18.0)
