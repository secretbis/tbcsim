...
@JsExport
public class SashOfArcaneVisions : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29257

    public override var name: String = "Sash of Arcane Visions"
    ...
    public override var stats: Stats =
        Stats(stamina = 18, intellect = 23, spirit = 19, armor = 105, spellCritRating = 22.0)
