...
@JsExport
public class NatashasGuardianCord : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31691

    public override var name: String = "Natasha's Guardian Cord"
    ...
    public override var stats: Stats = Stats(intellect = 10)
