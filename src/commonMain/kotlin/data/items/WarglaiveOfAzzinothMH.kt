...
@JsExport
public class WarglaiveOfAzzinothMH : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32837

    public override var name: String = "Warglaive of Azzinoth (MH)"
    ...
    public override var stats: Stats = Stats(agility = 22, stamina = 29, physicalHitRating = 21.0)
