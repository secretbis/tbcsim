...
@JsExport
public class DepletedMace : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32671

    public override var name: String = "Depleted Mace"
    ...
    public override var stats: Stats = Stats(meleeCritRating = 20.0, rangedCritRating = 20.0, physicalHitRating = 8.0)
