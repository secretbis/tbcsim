...
@JsExport
public class CordOfBraidedTrollHair : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33480

    public override var name: String = "Cord of Braided Troll Hair"
    ...
    public override var stats: Stats = Stats(stamina = 17, intellect = 34, armor = 121)
