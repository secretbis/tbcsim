...
@JsExport
public class KhoriumPants : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 23523

    public override var name: String = "Khorium Pants"

    public override var itemLevel: Int = 114

    public override var quality: Int = 3

    public override var icon: String = "inv_pants_plate_04.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 42, intellect = 28, armor = 1010)
