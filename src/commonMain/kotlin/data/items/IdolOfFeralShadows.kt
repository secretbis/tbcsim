...
@JsExport
public class IdolOfFeralShadows : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28372

    public override var name: String = "Idol of Feral Shadows"

    public override var itemLevel: Int = 115

    public override var quality: Int = 3

    public override var icon: String = "ability_druid_healinginstincts.jpg"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(34241, "Increased Rip Damage", this))
    }
}
