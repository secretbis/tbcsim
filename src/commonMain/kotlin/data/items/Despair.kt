...
@JsExport
public class Despair : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28573

    public override var name: String = "Despair"
    ...
    public override var stats: Stats = Stats(strength = 52)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(34580, "Impale", this)) }
}
