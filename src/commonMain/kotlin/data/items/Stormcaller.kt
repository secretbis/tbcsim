...
@JsExport
public class Stormcaller : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29155

    public override var name: String = "Stormcaller"
    ...
    public override var stats: Stats = Stats(stamina = 12, intellect = 12, spellCritRating = 21.0)
