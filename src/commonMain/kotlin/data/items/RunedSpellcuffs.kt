...
@JsExport
public class RunedSpellcuffs : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33588

    public override var name: String = "Runed Spell-cuffs"
    ...
    public override var stats: Stats = Stats(stamina = 20, intellect = 18, armor = 94, spellHasteRating = 25.0)
