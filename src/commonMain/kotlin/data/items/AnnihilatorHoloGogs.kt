...
@JsExport
public class AnnihilatorHoloGogs : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34847

    public override var name: String = "Annihilator Holo-Gogs"
    ...
    public override var stats: Stats = Stats(stamina = 41, intellect = 37, armor = 216, spellCritRating = 42.0)
