...
@JsExport
public class WarhelmOfTheBold : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28350

    public override var name: String = "Warhelm of the Bold"
    ...
    public override var stats: Stats =
        Stats(strength = 24, agility = 22, stamina = 23, armor = 946, defenseRating = 20.0)
