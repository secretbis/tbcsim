...
@JsExport
public class SpellfireBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 21846

    public override var name: String = "Spellfire Belt"

    public override var itemLevel: Int = 105

    public override var quality: Int = 4

    public override var icon: String = "inv_belt_04.jpg"
    ...
    public override var stats: Stats = Stats(intellect = 18, armor = 100, spellCritRating = 18.0)
