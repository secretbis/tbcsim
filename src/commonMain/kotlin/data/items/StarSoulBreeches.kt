...
@JsExport
public class StarSoulBreeches : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29977

    public override var name: String = "Star-Soul Breeches"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 27, spirit = 52, armor = 188)
