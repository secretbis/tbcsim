...
@JsExport
public class BracersOfJustice : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28512

    public override var name: String = "Bracers of Justice"
    ...
    public override var stats: Stats = Stats(stamina = 22, intellect = 22, armor = 634, spellCritRating = 16.0)
