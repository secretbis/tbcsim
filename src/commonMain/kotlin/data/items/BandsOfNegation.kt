...
@JsExport
public class BandsOfNegation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29240

    public override var name: String = "Bands of Negation"
    ...
    public override var stats: Stats = Stats(stamina = 25, intellect = 22, armor = 81)
