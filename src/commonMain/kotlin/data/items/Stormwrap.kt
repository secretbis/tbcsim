...
@JsExport
public class Stormwrap : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33536

    public override var name: String = "Stormwrap"
    ...
    public override var stats: Stats =
        Stats(stamina = 21, intellect = 26, armor = 506, spellCritRating = 22.0, spellHitRating = 13.0)
