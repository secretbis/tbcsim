...
@JsExport
public class NecklaceOfEternalHope : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29374

    public override var name: String = "Necklace of Eternal Hope"
    ...
    public override var stats: Stats = Stats(stamina = 22, intellect = 21)
