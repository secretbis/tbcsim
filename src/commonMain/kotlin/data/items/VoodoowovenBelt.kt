...
@JsExport
public class VoodoowovenBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33291

    public override var name: String = "Voodoo-woven Belt"
    ...
    public override var stats: Stats =
        Stats(stamina = 19, intellect = 22, armor = 121, spellCritRating = 33.0, spellHitRating = 17.0)
