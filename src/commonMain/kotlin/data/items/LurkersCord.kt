...
@JsExport
public class LurkersCord : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30675

    public override var name: String = "Lurker's Cord"
    ...
    public override var stats: Stats = Stats(armor = 109)
