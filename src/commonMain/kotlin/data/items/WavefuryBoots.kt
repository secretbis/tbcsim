...
@JsExport
public class WavefuryBoots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27549

    public override var name: String = "Wavefury Boots"
    ...
    public override var stats: Stats = Stats(stamina = 19, intellect = 24, armor = 448)
