...
@JsExport
public class Revenger : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28311

    public override var name: String = "Revenger"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(34107, "Drain Life", this)) }
}
