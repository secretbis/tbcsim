...
@JsExport
@Serializable
public class VengefulGladiatorsQuickblade : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 33734

  public override var name: String = "Vengeful Gladiator's Quickblade"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      VengefulGladiatorsQuickblade::class, serializer()) }
}
