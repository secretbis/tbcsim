...
@JsExport
public class AegisOfTheVindicator : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29458

    public override var name: String = "Aegis of the Vindicator"
    ...
    public override var stats: Stats = Stats(intellect = 21, armor = 5279)
