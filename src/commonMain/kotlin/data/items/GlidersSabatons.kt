...
@JsExport
public class GlidersSabatons : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30682

    public override var name: String = "Glider's Sabatons"
    ...
    public override var stats: Stats = Stats(armor = 558)
