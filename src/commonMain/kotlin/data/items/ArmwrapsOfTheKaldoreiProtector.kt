...
@JsExport
public class ArmwrapsOfTheKaldoreiProtector : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33578

    public override var name: String = "Armwraps of the Kaldorei Protector"
    ...
    public override var stats: Stats = Stats(stamina = 19, intellect = 22, armor = 177, spellCritRating = 20.0)
