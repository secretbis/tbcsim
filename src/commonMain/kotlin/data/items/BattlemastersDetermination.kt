...
@JsExport
@Serializable
public class BattlemastersDetermination : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 34578

  public override var name: String = "Battlemaster's Determination"

  public override var itemLevel: Int = 133

  public override var quality: Int = 4

  public override var icon: String = "ability_warrior_endlessrage.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BattlemastersDetermination::class, serializer()) }
}
