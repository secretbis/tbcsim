...
@JsExport
public class NetherfuryLeggings : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 25692

    public override var name: String = "Netherfury Leggings"
    ...
    public override var stats: Stats = Stats(stamina = 37, armor = 527)
