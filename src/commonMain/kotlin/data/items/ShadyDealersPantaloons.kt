...
@JsExport
public class ShadyDealersPantaloons : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30898

    public override var name: String = "Shady Dealer's Pantaloons"

    public override var itemLevel: Int = 141

    public override var quality: Int = 4

    public override var icon: String = "inv_pants_leather_25.jpg"
    ...
    public override var stats: Stats = Stats(agility = 50, stamina = 61, armor = 388)
