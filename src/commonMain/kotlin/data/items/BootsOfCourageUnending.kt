...
@JsExport
public class BootsOfCourageUnending : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30027

    public override var name: String = "Boots of Courage Unending"
    ...
    public override var stats: Stats = Stats(stamina = 19, intellect = 20, armor = 1105, spellCritRating = 31.0)
