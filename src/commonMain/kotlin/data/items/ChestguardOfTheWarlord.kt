...
@JsExport
public class ChestguardOfTheWarlord : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33473

    public override var name: String = "Chestguard of the Warlord"
    ...
    public override var stats: Stats =
        Stats(stamina = 60, armor = 1668, physicalHitRating = 26.0, defenseRating = 27.0, dodgeRating = 40.0)

    public override var sockets: Array<Socket> = arrayOf(Socket(Color.YELLOW), Socket(Color.RED), Socket(Color.BLUE))
