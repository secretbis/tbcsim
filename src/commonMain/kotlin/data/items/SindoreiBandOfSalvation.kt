...
@JsExport
public class SindoreiBandOfSalvation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 35283

    public override var name: String = "Sin'dorei Band of Salvation"
    ...
    public override var stats: Stats = Stats(stamina = 30, intellect = 19, resilienceRating = 19.0)
