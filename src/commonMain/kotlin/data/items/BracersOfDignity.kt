...
@JsExport
public class BracersOfDignity : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29252

    public override var name: String = "Bracers of Dignity"
    ...
    public override var stats: Stats = Stats(stamina = 30, intellect = 12, armor = 608, defenseRating = 21.0)
