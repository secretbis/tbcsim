...
@JsExport
public class ArcanoweaveBracers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 21866

    public override var name: String = "Arcanoweave Bracers"
    ...
    public override var stats: Stats = Stats(stamina = 31, armor = 67)
