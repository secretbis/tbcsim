...
@JsExport
public class IdolOfTheUnseenMoon : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33510

    public override var name: String = "Idol of the Unseen Moon"

    public override var itemLevel: Int = 128

    public override var quality: Int = 4

    public override var icon: String = "spell_nature_sentinal.jpg"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(43739, "Lunar Grace", this)) }
}
