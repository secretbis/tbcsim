...
@JsExport
public class ScaledBreastplateOfCarnage : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28599

    public override var name: String = "Scaled Breastplate of Carnage"

    public override var itemLevel: Int = 115

    public override var quality: Int = 4

    public override var icon: String = "inv_chest_chain_07.jpg"
    ...
    public override var stats: Stats =
        Stats(stamina = 33, intellect = 38, armor = 812, meleeCritRating = 24.0, rangedCritRating = 24.0)
