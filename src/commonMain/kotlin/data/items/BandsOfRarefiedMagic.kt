...
@JsExport
public class BandsOfRarefiedMagic : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29255

    public override var name: String = "Bands of Rarefied Magic"
    ...
    public override var stats: Stats = Stats(stamina = 22, intellect = 21, spirit = 16, armor = 81)
