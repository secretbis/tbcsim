...
@JsExport
public class BandsOfTheBenevolent : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29249

    public override var name: String = "Bands of the Benevolent"
    ...
    public override var stats: Stats = Stats(stamina = 18, intellect = 20, spirit = 18, armor = 81)
