...
@JsExport
public class MaleficGirdle : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28654

    public override var name: String = "Malefic Girdle"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 26, armor = 109, spellCritRating = 21.0)
