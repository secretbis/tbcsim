...
@JsExport
public class StarfireWaistband : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33559

    public override var name: String = "Starfire Waistband"
    ...
    public override var stats: Stats = Stats(stamina = 20, intellect = 23, armor = 227, spellCritRating = 22.0)
