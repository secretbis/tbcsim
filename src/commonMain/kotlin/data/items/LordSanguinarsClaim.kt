...
@JsExport
public class LordSanguinarsClaim : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30018

    public override var name: String = "Lord Sanguinar's Claim"
    ...
    public override var stats: Stats = Stats(stamina = 25, intellect = 19)
