...
@JsExport
public class WindhawkBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29524

    public override var name: String = "Windhawk Belt"
    ...
    public override var stats: Stats =
        Stats(stamina = 17, intellect = 19, spirit = 20, armor = 205, spellCritRating = 12.0)
