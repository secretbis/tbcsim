...
@JsExport
@Serializable
public class QuagmirransEye : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 27683

  public override var name: String = "Quagmirran's Eye"

  public override var itemLevel: Int = 115

  public override var quality: Int = 3

  public override var icon: String = "inv_misc_gem_pearl_01.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      QuagmirransEye::class, serializer()) }
}
