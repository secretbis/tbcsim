...
@JsExport
public class HurricaneBoots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30043

    public override var name: String = "Hurricane Boots"
    ...
    public override var stats: Stats = Stats(stamina = 25, intellect = 26, armor = 619, spellCritRating = 26.0)
