...
@JsExport
public class BootsOfTheRighteousPath : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29254

    public override var name: String = "Boots of the Righteous Path"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 26, armor = 955, defenseRating = 23.0)
