...
@JsExport
public class NaturewardensTreads : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32352

    public override var name: String = "Naturewarden's Treads"
    ...
    public override var stats: Stats = Stats(stamina = 39, intellect = 18, armor = 305, spellCritRating = 26.0)
