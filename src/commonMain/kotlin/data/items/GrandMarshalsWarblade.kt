...
@JsExport
public class GrandMarshalsWarblade : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28943

    public override var name: String = "Grand Marshal's Warblade"

    public override var itemLevel: Int = 115

    public override var quality: Int = 3

    public override var icon: String = "inv_sword_39.jpg"
