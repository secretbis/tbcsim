...
@JsExport
public class EnamelledDiscOfMojo : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33332

    public override var name: String = "Enamelled Disc of Mojo"

    public override var itemLevel: Int = 128

    public override var quality: Int = 4

    public override var icon: String = "inv_shield_43.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 24, intellect = 17, armor = 5400)
