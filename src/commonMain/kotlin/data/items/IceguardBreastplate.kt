...
@JsExport
public class IceguardBreastplate : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31369

    public override var name: String = "Iceguard Breastplate"
    ...
    public override var stats: Stats = Stats(stamina = 49, armor = 1450, defenseRating = 10.0)
