...
@JsExport
public class VindicatorsPendantOfSalvation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33922

    public override var name: String = "Vindicator's Pendant of Salvation"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 16, resilienceRating = 18.0)
