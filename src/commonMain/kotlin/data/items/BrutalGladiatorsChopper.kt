...
@JsExport
@Serializable
public class BrutalGladiatorsChopper : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 34995

  public override var name: String = "Brutal Gladiator's Chopper"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BrutalGladiatorsChopper::class, serializer()) }
}
