...
@JsExport
public class ZierhutsLostTreads : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30674

    public override var name: String = "Zierhut's Lost Treads"
    ...
    public override var stats: Stats = Stats(strength = 34, agility = 28, stamina = 33, armor = 390)
