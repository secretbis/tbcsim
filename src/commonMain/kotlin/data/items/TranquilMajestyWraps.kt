...
@JsExport
public class TranquilMajestyWraps : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34351

    public override var name: String = "Tranquil Majesty Wraps"

    public override var itemLevel: Int = 154

    public override var quality: Int = 4

    public override var icon: String = "inv_gauntlets_48.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 30, intellect = 28, spirit = 30, armor = 302)
