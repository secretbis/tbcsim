...
@JsExport
public class LibramOfRepentance : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29388

    public override var name: String = "Libram of Repentance"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(37742, "Increased Holy Shield Block", this))
    }
}
