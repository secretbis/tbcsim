...
@JsExport
@Serializable
public class VialOfTheSunwell : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 34471

  public override var name: String = "Vial of the Sunwell"

  public override var itemLevel: Int = 115

  public override var quality: Int = 4

  public override var icon: String = "inv_potion_106.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      VialOfTheSunwell::class, serializer()) }
}
