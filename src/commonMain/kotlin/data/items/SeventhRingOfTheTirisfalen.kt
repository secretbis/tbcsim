...
public class SeventhRingOfTheTirisfalen : Item() {
    ...
    public override var stats: Stats = Stats(stamina = 37, defenseRating = 17.0, blockRating = 24.0)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(23181, "Block Value 24", this)) }
}
