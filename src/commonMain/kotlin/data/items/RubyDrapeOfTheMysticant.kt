...
@JsExport
public class RubyDrapeOfTheMysticant : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28766

    public override var name: String = "Ruby Drape of the Mysticant"
    ...
    public override var stats: Stats = Stats(stamina = 22, intellect = 21, armor = 105, spellHitRating = 18.0)
