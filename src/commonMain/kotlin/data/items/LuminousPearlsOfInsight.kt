...
@JsExport
public class LuminousPearlsOfInsight : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 24462

    public override var name: String = "Luminous Pearls of Insight"

    public override var itemLevel: Int = 94

    public override var quality: Int = 3

    public override var icon: String = "inv_jewelry_necklace_10.jpg"
    ...
    public override var stats: Stats = Stats(intellect = 15, spellCritRating = 11.0)
