...
@JsExport
public class VeteransWyrmhideBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32808

    public override var name: String = "Veteran's Wyrmhide Belt"
    ...
    public override var stats: Stats = Stats(stamina = 39, intellect = 27, armor = 283, resilienceRating = 26.0)
