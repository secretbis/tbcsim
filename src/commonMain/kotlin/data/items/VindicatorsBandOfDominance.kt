...
@JsExport
public class VindicatorsBandOfDominance : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33853

    public override var name: String = "Vindicator's Band of Dominance"
    ...
    public override var stats: Stats = Stats(stamina = 31, intellect = 15, resilienceRating = 22.0)
