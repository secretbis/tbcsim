...
@JsExport
public class BeltOfNaturalPower : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30042

    public override var name: String = "Belt of Natural Power"
    ...
    public override var stats: Stats = Stats(strength = 29, agility = 20, stamina = 38, intellect = 12, armor = 423)
