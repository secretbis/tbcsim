...
@JsExport
public class VeteransBandOfSalvation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33064

    public override var name: String = "Veteran's Band of Salvation"
    ...
    public override var stats: Stats = Stats(stamina = 30, intellect = 17, resilienceRating = 22.0)
