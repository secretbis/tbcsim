...
@JsExport
public class BracersOfMartyrdom : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30871

    public override var name: String = "Bracers of Martyrdom"
    ...
    public override var stats: Stats = Stats(stamina = 15, intellect = 20, spirit = 28, armor = 103)
