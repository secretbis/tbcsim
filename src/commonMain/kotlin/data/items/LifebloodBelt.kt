...
@JsExport
public class LifebloodBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30463

    public override var name: String = "Lifeblood Belt"
    ...
    public override var stats: Stats = Stats(stamina = 16, intellect = 11, armor = 84)
