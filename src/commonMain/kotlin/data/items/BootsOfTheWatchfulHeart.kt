...
@JsExport
public class BootsOfTheWatchfulHeart : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28221

    public override var name: String = "Boots of the Watchful Heart"
    ...
    public override var stats: Stats = Stats(stamina = 23, intellect = 26, armor = 800)
