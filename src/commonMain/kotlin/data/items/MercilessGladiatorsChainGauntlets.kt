...
@JsExport
public class MercilessGladiatorsChainGauntlets : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31961

    public override var name: String = "Merciless Gladiator's Chain Gauntlets"
