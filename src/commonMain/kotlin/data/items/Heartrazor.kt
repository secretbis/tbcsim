...
public class Heartrazor : Item() {
    ...
    public override var stats: Stats = Stats(agility = 20, stamina = 30)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(36041, "Heartrazor", this)) }
}
