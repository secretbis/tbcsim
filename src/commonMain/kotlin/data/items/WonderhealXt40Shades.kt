...
@JsExport
public class WonderhealXt40Shades : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32479

    public override var name: String = "Wonderheal XT40 Shades"
    ...
    public override var stats: Stats = Stats(stamina = 15, intellect = 38, spirit = 22, armor = 326)
