...
@JsExport
public class LurkersGrasp : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30676

    public override var name: String = "Lurker's Grasp"
    ...
    public override var stats: Stats = Stats(armor = 205)
