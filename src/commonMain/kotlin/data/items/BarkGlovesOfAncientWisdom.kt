...
@JsExport
public class BarkGlovesOfAncientWisdom : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30029

    public override var name: String = "Bark-Gloves of Ancient Wisdom"
    ...
    public override var stats: Stats = Stats(stamina = 28, intellect = 25, spirit = 33, armor = 252)
