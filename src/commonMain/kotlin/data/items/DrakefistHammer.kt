...
@JsExport
public class DrakefistHammer : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28437

    public override var name: String = "Drakefist Hammer"

    public override var itemLevel: Int = 107

    public override var quality: Int = 4

    public override var icon: String = "inv_mace_37.jpg"
