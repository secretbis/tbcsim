...
@JsExport
public class CoifOfTheJungleStalker : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33432

    public override var name: String = "Coif of the Jungle Stalker"

    public override var itemLevel: Int = 133

    public override var quality: Int = 4

    public override var icon: String = "inv_helmet_113.jpg"
    ...
    public override var stats: Stats = Stats(agility = 36, stamina = 40, intellect = 35, armor = 759)
