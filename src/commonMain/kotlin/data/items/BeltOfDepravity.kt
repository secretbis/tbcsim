...
@JsExport
public class BeltOfDepravity : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29241

    public override var name: String = "Belt of Depravity"
    ...
    public override var stats: Stats = Stats(stamina = 31, intellect = 27, armor = 105, spellHitRating = 17.0)
