...
@JsExport
public class Powerheal9000Lens : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 35181

    public override var name: String = "Powerheal 9000 Lens"
    ...
    public override var stats: Stats = Stats(stamina = 33, intellect = 51, spirit = 41, armor = 216)
