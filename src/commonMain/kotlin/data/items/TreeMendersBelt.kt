...
@JsExport
public class TreeMendersBelt : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29264

    public override var name: String = "Tree-Mender's Belt"
    ...
    public override var stats: Stats = Stats(strength = 27, agility = 27, stamina = 22, intellect = 21, armor = 406)
