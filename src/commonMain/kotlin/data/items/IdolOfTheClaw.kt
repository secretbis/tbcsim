...
@JsExport
public class IdolOfTheClaw : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 25940

    public override var name: String = "Idol of the Claw"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(34323, "Finishing Move Heal", this))
    }
}
