...
@JsExport
@Serializable
public class BrutalGladiatorsLeftRipper : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35038

  public override var name: String = "Brutal Gladiator's Left Ripper"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BrutalGladiatorsLeftRipper::class, serializer()) }
}
