...
@JsExport
@Serializable
public class BrutalGladiatorsShiv : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35095

  public override var name: String = "Brutal Gladiator's Shiv"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BrutalGladiatorsShiv::class, serializer()) }
}
