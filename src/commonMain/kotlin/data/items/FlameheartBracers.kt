...
@JsExport
public class FlameheartBracers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30837

    public override var name: String = "Flameheart Bracers"
    ...
    public override var stats: Stats = Stats(stamina = 12, intellect = 8, armor = 67)
