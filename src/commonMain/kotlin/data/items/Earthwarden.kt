...
public class Earthwarden : Item() {
    ...
    public override var stats: Stats = Stats(stamina = 39, armor = 500, expertiseRating = 24.0, defenseRating = 27.0)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(44909, "Attack Power - Feral (+0712)", this))
    }
}
