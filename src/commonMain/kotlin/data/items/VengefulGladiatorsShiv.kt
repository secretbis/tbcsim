...
@JsExport
@Serializable
public class VengefulGladiatorsShiv : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 33756

  public override var name: String = "Vengeful Gladiator's Shiv"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      VengefulGladiatorsShiv::class, serializer()) }
}
