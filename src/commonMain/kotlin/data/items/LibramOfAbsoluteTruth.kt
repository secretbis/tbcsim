...
@JsExport
public class LibramOfAbsoluteTruth : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30063

    public override var name: String = "Libram of Absolute Truth"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(37739, "Reduced Holy Light Cost", this))
    }
}
