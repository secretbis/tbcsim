...
@JsExport
public class SwiftsteelGloves : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 23526

    public override var name: String = "Swiftsteel Gloves"
    ...
    public override var stats: Stats = Stats(armor = 407)
