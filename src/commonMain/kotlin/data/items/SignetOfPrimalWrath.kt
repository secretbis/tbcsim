...
@JsExport
public class SignetOfPrimalWrath : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33496

    public override var name: String = "Signet of Primal Wrath"
    ...
    public override var stats: Stats = Stats(agility = 28, stamina = 30)
