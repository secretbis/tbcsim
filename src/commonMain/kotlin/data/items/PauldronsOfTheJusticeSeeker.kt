...
@JsExport
public class PauldronsOfTheJusticeSeeker : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28666

    public override var name: String = "Pauldrons of the Justice-Seeker"
    ...
    public override var stats: Stats = Stats(stamina = 23, intellect = 26, armor = 1087, spellCritRating = 22.0)
