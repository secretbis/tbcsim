...
@JsExport
public class VengefulGladiatorsWarStaff : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33766

    public override var name: String = "Vengeful Gladiator's War Staff"
    ...
    public override var stats: Stats =
        Stats(stamina = 62, intellect = 46, spellCritRating = 46.0, resilienceRating = 29.0)
