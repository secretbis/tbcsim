...
@JsExport
public class FitzsThrowingAxe : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29211

    public override var name: String = "Fitz's Throwing Axe"

    public override var itemLevel: Int = 103

    public override var quality: Int = 3

    public override var icon: String = "inv_throwingaxe_06.jpg"
    ...
    public override var stats: Stats = Stats(agility = 12, physicalHitRating = 12.0)
