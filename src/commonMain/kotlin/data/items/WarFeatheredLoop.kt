...
@JsExport
public class WarFeatheredLoop : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33280

    public override var name: String = "War-Feathered Loop"
    ...
    public override var stats: Stats = Stats(agility = 29, stamina = 36, intellect = 28, armor = 506)
