...
@JsExport
public class BoraksBeltOfBravery : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30962

    public override var name: String = "Borak's Belt of Bravery"
    ...
    public override var stats: Stats = Stats(strength = 26, agility = 26, stamina = 24, armor = 622)
