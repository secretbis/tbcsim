...
@JsExport
public class ViciousHawkstriderHauberk : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34228

    public override var name: String = "Vicious Hawkstrider Hauberk"
    ...
    public override var stats: Stats = Stats(agility = 47, stamina = 64, intellect = 30, armor = 1110)
