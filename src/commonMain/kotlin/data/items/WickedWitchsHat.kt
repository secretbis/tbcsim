...
@JsExport
public class WickedWitchsHat : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28586

    public override var name: String = "Wicked Witch's Hat"
    ...
    public override var stats: Stats = Stats(stamina = 37, intellect = 38, armor = 158, spellCritRating = 32.0)
