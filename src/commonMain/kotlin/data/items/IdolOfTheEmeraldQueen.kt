...
@JsExport
public class IdolOfTheEmeraldQueen : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27886

    public override var name: String = "Idol of the Emerald Queen"

    public override var itemLevel: Int = 112

    public override var quality: Int = 3

    public override var icon: String = "spell_nature_natureresistancetotem.jpg"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(34246, "Increased Lifebloom Periodic", this))
    }
}
