...
@JsExport
public class ShiftingCamouflagePants : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33527

    public override var name: String = "Shifting Camouflage Pants"
    ...
    public override var stats: Stats = Stats(agility = 34, stamina = 45, intellect = 30, armor = 787)
