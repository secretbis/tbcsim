...
@JsExport
public class EluniteEmpoweredBracers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32351

    public override var name: String = "Elunite Empowered Bracers"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 22, armor = 194, spellHitRating = 19.0)
