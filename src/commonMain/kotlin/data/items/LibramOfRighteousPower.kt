...
@JsExport
public class LibramOfRighteousPower : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31033

    public override var name: String = "Libram of Righteous Power"

    public override var itemLevel: Int = 106

    public override var quality: Int = 3

    public override var icon: String = "inv_misc_book_13.jpg"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(37763, "Increased Crusader Strike Damage", this))
    }
}
