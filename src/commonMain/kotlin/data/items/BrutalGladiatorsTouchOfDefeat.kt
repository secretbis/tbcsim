...
@JsExport
public class BrutalGladiatorsTouchOfDefeat : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 35107

    public override var name: String = "Brutal Gladiator's Touch of Defeat"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 15, resilienceRating = 14.0)
