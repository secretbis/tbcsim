...
@JsExport
public class AdornmentOfStolenSouls : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28762

    public override var name: String = "Adornment of Stolen Souls"
    ...
    public override var stats: Stats = Stats(stamina = 18, intellect = 20, spellCritRating = 23.0)
