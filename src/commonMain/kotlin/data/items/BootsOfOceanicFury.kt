...
@JsExport
public class BootsOfOceanicFury : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32242

    public override var name: String = "Boots of Oceanic Fury"
    ...
    public override var stats: Stats = Stats(stamina = 28, intellect = 36, armor = 679, spellCritRating = 26.0)
