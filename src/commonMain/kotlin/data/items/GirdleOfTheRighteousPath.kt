...
@JsExport
public class GirdleOfTheRighteousPath : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29965

    public override var name: String = "Girdle of the Righteous Path"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 33, armor = 904, spellCritRating = 27.0)
