...
@JsExport
public class GuardiansBandOfSalvation : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 35130

    public override var name: String = "Guardian's Band of Salvation"
    ...
    public override var stats: Stats = Stats(stamina = 38, intellect = 23, resilienceRating = 22.0)
