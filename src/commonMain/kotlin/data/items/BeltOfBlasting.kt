...
@JsExport
public class BeltOfBlasting : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30038

    public override var name: String = "Belt of Blasting"
    ...
    public override var stats: Stats = Stats(armor = 121, spellCritRating = 30.0, spellHitRating = 23.0)
