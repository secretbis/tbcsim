...
@JsExport
public class MantleOfVivification : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 25805

    public override var name: String = "Mantle of Vivification"
    ...
    public override var stats: Stats = Stats(intellect = 18, armor = 74)
