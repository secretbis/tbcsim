...
@JsExport
public class EnchantedLeatherSandals : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30886

    public override var name: String = "Enchanted Leather Sandals"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 29, spirit = 37, armor = 305)
