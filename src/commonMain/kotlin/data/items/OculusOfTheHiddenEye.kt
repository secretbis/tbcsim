...
@JsExport
@Serializable
public class OculusOfTheHiddenEye : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 26055

  public override var name: String = "Oculus of the Hidden Eye"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      OculusOfTheHiddenEye::class, serializer()) }
}
