...
public class SoulCleaver : Item() {
    ...
    public override var stats: Stats = Stats(strength = 65, stamina = 63)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(42109, "Armor Penetration", this)) }
}
