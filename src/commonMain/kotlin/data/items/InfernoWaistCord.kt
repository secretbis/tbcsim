...
@JsExport
public class InfernoWaistCord : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30673

    public override var name: String = "Inferno Waist Cord"
    ...
    public override var stats: Stats = Stats(intellect = 18, armor = 109, spellCritRating = 24.0)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(26694, "Increase Fire Dam 59", this))
    }
}
