...
@JsExport
public class GladiatorsRightRipper : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28313

    public override var name: String = "Gladiator's Right Ripper"
    ...
    public override var minDmg: Double = 166.0
