...
public class WorldBreaker : Item() {
    ...
    public override var stats: Stats = Stats(strength = 50, stamina = 51)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(36111, "World Breaker", this)) }
}
