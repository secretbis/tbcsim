...
@JsExport
public class BlessedMedallionOfKarabor : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32757

    public override var name: String = "Blessed Medallion of Karabor"
    ...
    public override var stats: Stats = Stats(stamina = 49)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(41234, "Teleport: Black Temple", this))
    }
}
