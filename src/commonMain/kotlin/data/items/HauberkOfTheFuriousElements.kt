...
@JsExport
public class HauberkOfTheFuriousElements : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33965

    public override var name: String = "Hauberk of the Furious Elements"
    ...
    public override var stats: Stats =
        Stats(stamina = 39, intellect = 34, armor = 900, spellCritRating = 23.0, spellHasteRating = 35.0)
