...
@JsExport
public class BootsOfTheLongRoad : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30035

    public override var name: String = "Boots of the Long Road"
    ...
    public override var stats: Stats = Stats(stamina = 25, intellect = 26, spirit = 22, armor = 148)
