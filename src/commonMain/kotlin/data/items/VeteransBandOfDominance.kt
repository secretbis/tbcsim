...
@JsExport
public class VeteransBandOfDominance : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33056

    public override var name: String = "Veteran's Band of Dominance"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 12, resilienceRating = 22.0)
