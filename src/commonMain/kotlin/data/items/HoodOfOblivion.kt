...
@JsExport
public class HoodOfOblivion : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28415

    public override var name: String = "Hood of Oblivion"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 32, armor = 127)
