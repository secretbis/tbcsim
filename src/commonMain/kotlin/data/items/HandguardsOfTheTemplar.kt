...
@JsExport
public class HandguardsOfTheTemplar : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33519

    public override var name: String = "Handguards of the Templar"
    ...
    public override var stats: Stats = Stats(stamina = 25, intellect = 28, armor = 1005, spellHasteRating = 25.0)
