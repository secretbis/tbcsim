...
public class TheBladeOfHarbingers : Item() {
    ...
    public override var stats: Stats =
        Stats(meleeCritRating = 55.0, rangedCritRating = 55.0, physicalHasteRating = 53.0)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(33782, "Attack Power 108", this)) }
}
