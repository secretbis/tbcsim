...
@JsExport
public class BeltOfTheTracker : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30643

    public override var name: String = "Belt of the Tracker"
    ...
    public override var stats: Stats = Stats(intellect = 15, armor = 457)
