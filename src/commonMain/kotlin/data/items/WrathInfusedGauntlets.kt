...
@JsExport
public class WrathInfusedGauntlets : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32077

    public override var name: String = "Wrath Infused Gauntlets"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 28, armor = 486)
