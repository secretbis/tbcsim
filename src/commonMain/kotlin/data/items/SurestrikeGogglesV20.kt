...
@JsExport
public class SurestrikeGogglesV20 : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32474

    public override var name: String = "Surestrike Goggles v2.0"
    ...
    public override var stats: Stats =
        Stats(stamina = 28, armor = 726, meleeCritRating = 38.0, rangedCritRating = 38.0, physicalHitRating = 13.0)
