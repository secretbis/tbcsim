...
@JsExport
public class BlessedBookOfNagrand : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 25644

    public override var name: String = "Blessed Book of Nagrand"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(32403, "Increased Flash of Light Healing", this))
    }
}
