...
@JsExport
public class EterniumShellBracers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32232

    public override var name: String = "Eternium Shell Bracers"
    ...
    public override var stats: Stats = Stats(stamina = 52, armor = 772, defenseRating = 24.0, dodgeRating = 26.0)
