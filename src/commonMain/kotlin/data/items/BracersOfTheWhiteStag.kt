...
@JsExport
public class BracersOfTheWhiteStag : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28453

    public override var name: String = "Bracers of the White Stag"
    ...
    public override var stats: Stats = Stats(stamina = 16, intellect = 18, spirit = 22, armor = 159)
