...
@JsExport
@Serializable
public class FelReaversPiston : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 30619

  public override var name: String = "Fel Reaver's Piston"

  public override var itemLevel: Int = 128

  public override var quality: Int = 4

  public override var icon: String = "inv_misc_enggizmos_14.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      FelReaversPiston::class, serializer()) }
}
