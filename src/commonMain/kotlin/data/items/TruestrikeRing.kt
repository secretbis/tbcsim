...
@JsExport
public class TruestrikeRing : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31326

    public override var name: String = "Truestrike Ring"

    public override var itemLevel: Int = 100

    public override var quality: Int = 4

    public override var icon: String = "inv_jewelry_ring_58.jpg"
