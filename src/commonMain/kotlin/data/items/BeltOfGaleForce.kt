...
@JsExport
public class BeltOfGaleForce : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28567

    public override var name: String = "Belt of Gale Force"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 28, armor = 457)
