...
@JsExport
public class WrapsOfPurification : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32516

    public override var name: String = "Wraps of Purification"
    ...
    public override var stats: Stats = Stats(stamina = 24, intellect = 25, armor = 94)
