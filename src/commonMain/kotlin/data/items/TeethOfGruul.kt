...
@JsExport
public class TeethOfGruul : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28822

    public override var name: String = "Teeth of Gruul"

    public override var itemLevel: Int = 125

    public override var quality: Int = 4

    public override var icon: String = "inv_misc_bone_09.jpg"
    ...
    public override var stats: Stats = Stats(intellect = 21, spirit = 19)
