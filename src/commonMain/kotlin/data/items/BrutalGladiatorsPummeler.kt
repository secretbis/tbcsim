...
@JsExport
@Serializable
public class BrutalGladiatorsPummeler : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35071

  public override var name: String = "Brutal Gladiator's Pummeler"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BrutalGladiatorsPummeler::class, serializer()) }
}
