...
@JsExport
public class SabatonsOfTheRighteousDefender : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33523

    public override var name: String = "Sabatons of the Righteous Defender"
    ...
    public override var stats: Stats = Stats(stamina = 45, armor = 1105, spellHitRating = 18.0, defenseRating = 18.0)
