...
@JsExport
public class GoldenLinksOfRestoration : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30887

    public override var name: String = "Golden Links of Restoration"
    ...
    public override var stats: Stats = Stats(stamina = 51, intellect = 35, armor = 988)
