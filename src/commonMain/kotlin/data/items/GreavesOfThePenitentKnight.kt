...
@JsExport
public class GreavesOfThePenitentKnight : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34612

    public override var name: String = "Greaves of the Penitent Knight"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 25, armor = 1080)
