...
@JsExport
public class IdolOfUrsoc : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27744

    public override var name: String = "Idol of Ursoc"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(34253, "Increased Lacerate Damage", this))
    }
}
