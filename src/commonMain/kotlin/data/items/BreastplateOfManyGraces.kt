...
@JsExport
public class BreastplateOfManyGraces : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27897

    public override var name: String = "Breastplate of Many Graces"
    ...
    public override var stats: Stats = Stats(stamina = 40, intellect = 28, armor = 1135)
