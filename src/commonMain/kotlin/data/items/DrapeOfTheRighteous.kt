...
@JsExport
public class DrapeOfTheRighteous : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30642

    public override var name: String = "Drape of the Righteous"
    ...
    public override var stats: Stats = Stats(intellect = 13, armor = 97)
