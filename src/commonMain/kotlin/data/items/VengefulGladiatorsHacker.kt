...
@JsExport
@Serializable
public class VengefulGladiatorsHacker : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 33689

  public override var name: String = "Vengeful Gladiator's Hacker"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      VengefulGladiatorsHacker::class, serializer()) }
}
