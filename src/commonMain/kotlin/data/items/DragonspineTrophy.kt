...
@JsExport
@Serializable
public class DragonspineTrophy : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 28830

  public override var name: String = "Dragonspine Trophy"

  public override var itemLevel: Int = 125

  public override var quality: Int = 4

  public override var icon: String = "inv_misc_bone_03.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      DragonspineTrophy::class, serializer()) }
}
