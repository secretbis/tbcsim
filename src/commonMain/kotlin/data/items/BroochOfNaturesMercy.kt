...
@JsExport
public class BroochOfNaturesMercy : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33281

    public override var name: String = "Brooch of Nature's Mercy"

    public override var itemLevel: Int = 128

    public override var quality: Int = 4

    public override var icon: String = "inv_jewelry_necklace_ahnqiraj_03.jpg"
    ...
    public override var stats: Stats = Stats(intellect = 24, spirit = 19, spellHasteRating = 33.0)
