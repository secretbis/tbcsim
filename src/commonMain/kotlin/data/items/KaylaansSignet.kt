...
@JsExport
public class KaylaansSignet : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30860

    public override var name: String = "Kaylaan's Signet"
    ...
    public override var stats: Stats = Stats(agility = 15, physicalHitRating = 10.0)
