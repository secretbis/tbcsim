...
@JsExport
public class SkystalkersGloves : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31567

    public override var name: String = "Skystalker's Gloves"
    ...
    public override var stats: Stats = Stats(armor = 183)
