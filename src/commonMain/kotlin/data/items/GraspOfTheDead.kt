...
@JsExport
public class GraspOfTheDead : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30668

    public override var name: String = "Grasp of the Dead"
    ...
    public override var stats: Stats = Stats(intellect = 24, spirit = 21, armor = 121, spellHitRating = 17.0)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(17905, "Increase Frost Dam 46", this))
    }
}
