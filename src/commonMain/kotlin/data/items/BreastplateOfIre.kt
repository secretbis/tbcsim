...
@JsExport
public class BreastplateOfIre : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 34942

    public override var name: String = "Breastplate of Ire"
    ...
    public override var stats: Stats = Stats(strength = 52, stamina = 64, armor = 1765, physicalHasteRating = 51.0)
