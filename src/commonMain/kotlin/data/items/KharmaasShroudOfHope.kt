...
@JsExport
public class KharmaasShroudOfHope : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33333

    public override var name: String = "Kharmaa's Shroud of Hope"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 15, armor = 114, resilienceRating = 23.0)
