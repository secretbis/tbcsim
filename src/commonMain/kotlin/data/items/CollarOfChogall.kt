...
@JsExport
public class CollarOfChogall : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28804

    public override var name: String = "Collar of Cho'gall"
    ...
    public override var stats: Stats = Stats(stamina = 42, intellect = 36, armor = 171)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(26227, "Increase Spell Dam 68", this))
    }
}
