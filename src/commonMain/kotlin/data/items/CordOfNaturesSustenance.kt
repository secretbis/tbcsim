...
@JsExport
public class CordOfNaturesSustenance : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28655

    public override var name: String = "Cord of Nature's Sustenance"
    ...
    public override var stats: Stats = Stats(stamina = 24, intellect = 30, spirit = 16, armor = 205)
