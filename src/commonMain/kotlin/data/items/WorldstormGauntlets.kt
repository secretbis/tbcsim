...
@JsExport
public class WorldstormGauntlets : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29976

    public override var name: String = "Worldstorm Gauntlets"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 22, armor = 562, spellCritRating = 15.0)
