...
@JsExport
public class HammerOfAtonement : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30918

    public override var name: String = "Hammer of Atonement"
    ...
    public override var stats: Stats = Stats(stamina = 31, intellect = 21, spellCritRating = 23.0)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(42110, "Increase Healing 443", this))
    }
}
