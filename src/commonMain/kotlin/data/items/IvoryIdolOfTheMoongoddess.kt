...
@JsExport
public class IvoryIdolOfTheMoongoddess : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27518

    public override var name: String = "Ivory Idol of the Moongoddess"

    public override var itemLevel: Int = 112

    public override var quality: Int = 3

    public override var icon: String = "spell_arcane_arcane03.jpg"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(34292, "Improved Starfire", this)) }
}
