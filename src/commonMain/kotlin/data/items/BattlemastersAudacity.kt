...
@JsExport
@Serializable
public class BattlemastersAudacity : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 34579

  public override var name: String = "Battlemaster's Audacity"

  public override var itemLevel: Int = 133

  public override var quality: Int = 4

  public override var icon: String = "spell_nature_focusedmind.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BattlemastersAudacity::class, serializer()) }
}
