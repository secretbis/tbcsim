...
@JsExport
public class LibramOfMending : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33502

    public override var name: String = "Libram of Mending"

    public override var itemLevel: Int = 128

    public override var quality: Int = 4

    public override var icon: String = "inv_relics_libramoftruth.jpg"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(43741, "Light's Grace", this)) }
}
