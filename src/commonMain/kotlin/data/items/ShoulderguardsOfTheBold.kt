...
@JsExport
public class ShoulderguardsOfTheBold : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27803

    public override var name: String = "Shoulderguards of the Bold"
    ...
    public override var stats: Stats = Stats(strength = 25, stamina = 25, armor = 873, defenseRating = 17.0)
