...
@JsExport
@Serializable
public class VengefulGladiatorsSlicer : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 33762

  public override var name: String = "Vengeful Gladiator's Slicer"

  public override var itemLevel: Int = 146

  public override var quality: Int = 4

  public override var icon: String = "inv_sword_89.jpg"
  ...
  public override var maxDmg: Double = 322.0
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      VengefulGladiatorsSlicer::class, serializer()) }
}
