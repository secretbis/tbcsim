...
@JsExport
public class NethervoidCloak : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32590

    public override var name: String = "Nethervoid Cloak"
    ...
    public override var stats: Stats = Stats(stamina = 27, intellect = 18, armor = 118, spellHitRating = 18.0)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(18027, "Increase Shadow Dam 53", this))
    }
}
