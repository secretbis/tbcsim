...
@JsExport
public class FelstoneMantle : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31162

    public override var name: String = "Felstone Mantle"
    ...
    public override var stats: Stats = Stats(armor = 111)
