...
@JsExport
@Serializable
public class FaolsSignetOfCleansing : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 27477

  public override var name: String = "Faol's Signet of Cleansing"

  public override var itemLevel: Int = 115

  public override var quality: Int = 3

  public override var icon: String = "inv_staff_24.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      FaolsSignetOfCleansing::class, serializer()) }
}
