...
@JsExport
@Serializable
public class VengefulGladiatorsRightRipper : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 33737

  public override var name: String = "Vengeful Gladiator's Right Ripper"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      VengefulGladiatorsRightRipper::class, serializer()) }
}
