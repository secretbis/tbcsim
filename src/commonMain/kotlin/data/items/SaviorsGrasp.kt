...
@JsExport
public class SaviorsGrasp : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30904

    public override var name: String = "Savior's Grasp"
    ...
    public override var stats: Stats = Stats(stamina = 69, intellect = 48, armor = 1886, spellCritRating = 46.0)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(26225, "Increase Healing 106", this))
    }
}
