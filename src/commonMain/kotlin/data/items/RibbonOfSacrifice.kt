...
@JsExport
@Serializable
public class RibbonOfSacrifice : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 28590

  public override var name: String = "Ribbon of Sacrifice"

  public override var itemLevel: Int = 115

  public override var quality: Int = 4

  public override var icon: String = "inv_misc_bandage_16.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      RibbonOfSacrifice::class, serializer()) }
}
