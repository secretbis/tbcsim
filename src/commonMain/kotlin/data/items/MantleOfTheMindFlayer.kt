...
@JsExport
public class MantleOfTheMindFlayer : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28726

    public override var name: String = "Mantle of the Mind Flayer"
    ...
    public override var stats: Stats = Stats(stamina = 33, intellect = 29, armor = 146)
