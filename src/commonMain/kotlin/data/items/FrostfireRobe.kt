...
@JsExport
public class FrostfireRobe : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 22496

    public override var name: String = "Frostfire Robe"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 27, armor = 158)
