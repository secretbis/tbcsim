...
@JsExport
public class LibramOfTheEternalRest : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27917

    public override var name: String = "Libram of the Eternal Rest"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(34252, "Improved Consecration", this))
    }
}
