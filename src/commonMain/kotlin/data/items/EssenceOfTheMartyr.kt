...
@JsExport
@Serializable
public class EssenceOfTheMartyr : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 29376

  public override var name: String = "Essence of the Martyr"

  public override var itemLevel: Int = 110

  public override var quality: Int = 4

  public override var icon: String = "inv_valentineperfumebottle.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      EssenceOfTheMartyr::class, serializer()) }
}
