...
@JsExport
public class GlidersBoots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30681

    public override var name: String = "Glider's Boots"
    ...
    public override var stats: Stats = Stats(armor = 250)
