...
@JsExport
@Serializable
public class BrutalGladiatorsHacker : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 35017

  public override var name: String = "Brutal Gladiator's Hacker"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      BrutalGladiatorsHacker::class, serializer()) }
}
