...
@JsExport
public class MarshalsWyrmhideBoots : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29005

    public override var name: String = "Marshal's Wyrmhide Boots"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 23, armor = 307, resilienceRating = 24.0)
