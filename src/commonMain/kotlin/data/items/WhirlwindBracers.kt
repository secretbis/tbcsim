...
@JsExport
public class WhirlwindBracers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28503

    public override var name: String = "Whirlwind Bracers"
    ...
    public override var stats: Stats = Stats(stamina = 19, intellect = 20, armor = 355)
