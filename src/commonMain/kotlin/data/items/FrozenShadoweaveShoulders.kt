...
@JsExport
public class FrozenShadoweaveShoulders : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 21869

    public override var name: String = "Frozen Shadoweave Shoulders"
    ...
    public override var stats: Stats = Stats(stamina = 21, intellect = 15, armor = 133)
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(
            Buffs.byIdOrName(18025, "Increase Shadow Dam 50", this),
            Buffs.byIdOrName(17908, "Increase Frost Dam 50", this),
        )
    }
}
