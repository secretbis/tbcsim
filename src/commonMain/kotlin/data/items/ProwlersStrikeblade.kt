...
@JsExport
public class ProwlersStrikeblade : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33298

    public override var name: String = "Prowler's Strikeblade"

    public override var itemLevel: Int = 132

    public override var quality: Int = 4

    public override var icon: String = "inv_weapon_shortblade_65.jpg"
