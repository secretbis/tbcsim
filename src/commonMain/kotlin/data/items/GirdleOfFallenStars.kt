...
@JsExport
public class GirdleOfFallenStars : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30030

    public override var name: String = "Girdle of Fallen Stars"
    ...
    public override var stats: Stats = Stats(stamina = 26, intellect = 18, armor = 506)
