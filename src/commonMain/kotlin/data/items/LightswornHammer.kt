...
@JsExport
public class LightswornHammer : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27538

    public override var name: String = "Lightsworn Hammer"

    public override var itemLevel: Int = 115

    public override var quality: Int = 3

    public override var icon: String = "inv_hammer_23.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 12, intellect = 11)
