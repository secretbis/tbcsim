...
@JsExport
public class IdolOfSavagery : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27990

    public override var name: String = "Idol of Savagery"

    public override var itemLevel: Int = 91

    public override var quality: Int = 3

    public override var icon: String = "inv_relics_idolofferocity.jpg"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(33565, "Claw and Rake Damage Bonus", this))
    }
}
