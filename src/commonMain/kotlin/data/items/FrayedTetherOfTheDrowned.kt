...
@JsExport
public class FrayedTetherOfTheDrowned : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30099

    public override var name: String = "Frayed Tether of the Drowned"
    ...
    public override var stats: Stats = Stats(stamina = 45, physicalHitRating = 18.0, defenseRating = 24.0)
