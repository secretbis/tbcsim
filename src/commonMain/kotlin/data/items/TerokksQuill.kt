...
@JsExport
public class TerokksQuill : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29329

    public override var name: String = "Terokk's Quill"
    ...
    public override var stats: Stats = Stats(agility = 54, stamina = 33)
