...
public class SwordBreakersBulwark : Item() {
    ...
    public override var stats: Stats = Stats(stamina = 49, armor = 6459, defenseRating = 20.0, blockRating = 16.0)
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(42078, "Block Value 47", this)) }
}
