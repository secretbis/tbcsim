...
@JsExport
public class IdolOfTheAvianHeart : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28568

    public override var name: String = "Idol of the Avian Heart"

    public override var itemLevel: Int = 115

    public override var quality: Int = 4

    public override var icon: String = "inv_misc_thegoldencheep.jpg"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(38321, "Improved Healing Touch", this))
    }
}
