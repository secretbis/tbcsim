...
@JsExport
public class TerrorPitGirdle : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28778

    public override var name: String = "Terror Pit Girdle"
    ...
    public override var stats: Stats =
        Stats(stamina = 18, intellect = 22, armor = 495, meleeCritRating = 21.0, rangedCritRating = 21.0)
