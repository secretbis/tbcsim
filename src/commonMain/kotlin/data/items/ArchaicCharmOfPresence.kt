...
@JsExport
public class ArchaicCharmOfPresence : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30726

    public override var name: String = "Archaic Charm of Presence"
    ...
    public override var stats: Stats = Stats(intellect = 23)
