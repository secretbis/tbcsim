...
@JsExport
public class GirdleOfTruth : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28733

    public override var name: String = "Girdle of Truth"
    ...
    public override var stats: Stats = Stats(stamina = 28, intellect = 29, armor = 816)
