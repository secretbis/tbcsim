...
@JsExport
public class RedemptionTunic : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 22425

    public override var name: String = "Redemption Tunic"
    ...
    public override var stats: Stats = Stats(stamina = 25, intellect = 31, armor = 1172)
