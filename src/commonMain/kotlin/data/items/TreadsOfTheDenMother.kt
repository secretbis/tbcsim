...
@JsExport
public class TreadsOfTheDenMother : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 32593

    public override var name: String = "Treads of the Den Mother"
    ...
    public override var stats: Stats = Stats(strength = 38, agility = 32, stamina = 47, intellect = 14, armor = 516)
