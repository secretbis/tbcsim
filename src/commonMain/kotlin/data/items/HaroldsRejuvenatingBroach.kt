...
@JsExport
public class HaroldsRejuvenatingBroach : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 25643

    public override var name: String = "Harold's Rejuvenating Broach"

    public override var itemLevel: Int = 103

    public override var quality: Int = 3

    public override var icon: String = "inv_relics_idolofrejuvenation.jpg"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(32402, "Increased Rejuvenation Healing", this))
    }
}
