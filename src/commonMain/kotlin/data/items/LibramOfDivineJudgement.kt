...
@JsExport
public class LibramOfDivineJudgement : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33503

    public override var name: String = "Libram of Divine Judgement"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(43745, "Crusader's Command", this)) }
}
