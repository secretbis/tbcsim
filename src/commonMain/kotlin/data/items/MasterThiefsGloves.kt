...
@JsExport
public class MasterThiefsGloves : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29357

    public override var name: String = "Master Thief's Gloves"
    ...
    public override var stats: Stats = Stats(agility = 23, stamina = 25, armor = 218)
