...
@JsExport
public class LibramOfTheLightbringer : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 28296

    public override var name: String = "Libram of the Lightbringer"
    ...
    public override val buffs: List<Buff> by lazy {
        listOfNotNull(Buffs.byIdOrName(34231, "Increased Holy Light Healing", this))
    }
}
