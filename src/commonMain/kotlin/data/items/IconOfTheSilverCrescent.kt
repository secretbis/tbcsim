...
@JsExport
@Serializable
public class IconOfTheSilverCrescent : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 29370

  public override var name: String = "Icon of the Silver Crescent"

  public override var itemLevel: Int = 110

  public override var quality: Int = 4

  public override var icon: String = "inv_weapon_shortblade_23.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      IconOfTheSilverCrescent::class, serializer()) }
}
