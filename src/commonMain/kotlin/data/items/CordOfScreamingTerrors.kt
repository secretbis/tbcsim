...
@JsExport
public class CordOfScreamingTerrors : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30064

    public override var name: String = "Cord of Screaming Terrors"
    ...
    public override var stats: Stats = Stats(stamina = 34, intellect = 15, armor = 121, spellHitRating = 24.0)
