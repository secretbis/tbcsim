...
@JsExport
@Serializable
public class TomeOfDiabolicRemedy : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 33828

  public override var name: String = "Tome of Diabolic Remedy"

  public override var itemLevel: Int = 133

  public override var quality: Int = 4

  public override var icon: String = "inv_offhand_stratholme_a_01.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      TomeOfDiabolicRemedy::class, serializer()) }
}
