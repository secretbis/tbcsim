...
@JsExport
public class WindhawkBracers : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29523

    public override var name: String = "Windhawk Bracers"
    ...
    public override var stats: Stats =
        Stats(stamina = 22, intellect = 17, spirit = 7, armor = 159, spellCritRating = 16.0)
