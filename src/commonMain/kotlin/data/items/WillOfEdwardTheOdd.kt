...
@JsExport
public class WillOfEdwardTheOdd : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 31340

    public override var name: String = "Will of Edward the Odd"
    ...
    public override var stats: Stats = Stats(intellect = 30, armor = 170, spellCritRating = 30.0)
