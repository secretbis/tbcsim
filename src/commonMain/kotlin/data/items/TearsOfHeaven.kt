...
@JsExport
@Serializable
public class TearsOfHeaven : Item() {
  public override var isAutoGenerated: Boolean = true

  public override var id: Int = 29274

  public override var name: String = "Tears of Heaven"

  public override var itemLevel: Int = 110

  public override var quality: Int = 4

  public override var icon: String = "inv_potion_75.jpg"
  ...
  public override fun itemSerializersModule() = SerializersModule { polymorphic(Item::class,
      TearsOfHeaven::class, serializer()) }
}
