...
@JsExport
public class PauldronsOfTheArgentSentinel : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 30084

    public override var name: String = "Pauldrons of the Argent Sentinel"
    ...
    public override var stats: Stats = Stats(intellect = 34, armor = 1206, spellCritRating = 32.0)
