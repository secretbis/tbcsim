...
@JsExport
public class TalismanOfTheBreaker : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 29347

    public override var name: String = "Talisman of the Breaker"

    public override var itemLevel: Int = 110

    public override var quality: Int = 4

    public override var icon: String = "ability_hunter_mastermarksman.jpg"
    ...
    public override var stats: Stats = Stats(stamina = 18, intellect = 17)
