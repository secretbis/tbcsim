...
@JsExport
public class NaturalLifeLeggings : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 33530

    public override var name: String = "Natural Life Leggings"
    ...
    public override var stats: Stats = Stats(stamina = 45, intellect = 38, armor = 787, spellCritRating = 17.0)
