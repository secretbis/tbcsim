...
@JsExport
public class LibramOfAvengement : Item() {
    public override var isAutoGenerated: Boolean = true

    public override var id: Int = 27484

    public override var name: String = "Libram of Avengement"

    public override var itemLevel: Int = 115

    public override var quality: Int = 3

    public override var icon: String = "inv_misc_stonetablet_05.jpg"
    ...
    public override val buffs: List<Buff> by lazy { listOfNotNull(Buffs.byIdOrName(34258, "Justice", this)) }
}
