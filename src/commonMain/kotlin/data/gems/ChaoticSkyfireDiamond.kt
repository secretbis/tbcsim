...
@JsExport
class ChaoticSkyfireDiamond :
    Gem(34220, "Chaotic Skyfire Diamond", "inv_misc_gem_diamond_07.jpg", null, Color.META, Quality.META) {
    val buff =
        object : Buff() {
            ...
            // TODO: on my quest for critdmg calculation i found out this critMultiplier applies to
            // the
            // full dmg of the crit, not just the bonus damage. this has to be applied to the base
            // critMultiplier (Stats.physicalCritMultiplier etc.) before handling multipliers
