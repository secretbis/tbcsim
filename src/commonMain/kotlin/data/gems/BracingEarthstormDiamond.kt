...
@JsExport
class BracingEarthstormDiamond :
    Gem(25897, "Bracing Earthstorm Diamond", "inv_misc_gem_diamond_06.jpg", null, Color.META, Quality.META) {
    val buff =
        object : Buff() {
            ...
            override fun modifyStats(sp: SimParticipant): Stats {
                return Stats(spellHealing = 26, spellDamage = 9)
            }
        }
