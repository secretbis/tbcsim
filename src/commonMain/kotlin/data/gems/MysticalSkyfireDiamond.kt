...
@JsExport
class MysticalSkyfireDiamond :
    Gem(25893, "Mystical Skyfire Diamond", "inv_misc_gem_diamond_07.jpg", null, Color.META, Quality.META) {
            ...
            val proc =
                object : Proc() {
                    override val triggers: List<Trigger> =
                        listOf(Trigger.SPELL_HIT, Trigger.SPELL_CRIT, Trigger.SPELL_RESIST)
    ...
    override fun metaActive(sockets: List<Socket>): Boolean {
        ...
        return byColor[Color.BLUE] ?: 0 > byColor[Color.YELLOW] ?: 0
    }
