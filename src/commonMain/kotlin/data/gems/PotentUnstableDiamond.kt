...
@JsExport
class PotentUnstableDiamond :
    Gem(32640, "Potent Unstable Diamond", "inv_misc_gem_diamond_07.jpg", null, Color.META, Quality.META) {
    val buff =
        object : Buff() {
            override val name: String = "Potent Unstable Diamond"
            override val icon: String = "inv_misc_gem_diamond_07.jpg"
