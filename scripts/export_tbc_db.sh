...
items_columns="entry,class,subclass,name,displayid,Quality,Flags,AllowableClass,AllowableRace,ItemLevel,"
...
items_columns+="armor,holy_res,fire_res,nature_res,frost_res,shadow_res,arcane_res,"
...
items_columns+="description,itemset,"
items_columns+="socketColor_1,socketColor_2,socketColor_3,socketBonus,"
items_columns+="ArmorDamageModifier,ExtraFlags"
...
spells_output_path=src/main/resources/spells.json
